 ...
 * @return array
 */
function get_sales_opp_tabs_admin($project_id)
{
    $project_tabs = array(
    array(
        'name'=>'project_overview',
        'url'=>admin_url('sales/view/'.$project_id.'?group=project_overview'),
        'icon'=>'fa fa-th',
    ...
    array(
        'name'=>'project_tasks',
        'url'=>admin_url('sales/view/'.$project_id.'?group=project_tasks'),
    ...
    array(
        ...
        'url'=>admin_url('sales/view/'.$project_id.'?group=project_timesheets'),
        'icon'=>'fa fa-clock-o',
    ...
    array(
        ...
        'url'=>admin_url('sales/view/'.$project_id.'?group=project_milestones'),
        'icon'=>'fa fa-rocket',
    ...
    array(
        'name'=>'project_files',
        'url'=>admin_url('sales/view/'.$project_id.'?group=project_files'),
        'icon'=>'fa fa-files-o',
    ...
    array(
        ...
        'url'=>admin_url('sales/view/'.$project_id.'?group=project_discussions'),
    ...
    array(
        'name'=>'project_gantt',
        'url'=>admin_url('sales/view/'.$project_id.'?group=project_gantt'),
    ...
    array(
        ...
        'url'=>admin_url('sales/view/'.$project_id.'?group=project_tickets'),
    ...
    array(
        ...
        'dropdown'=>array(
          array(
            ...
            'url'=>admin_url('sales/view/'.$project_id.'?group=project_invoices'),
            'icon'=>'fa fa-sun-o',
          ...
          array(
            ...
            'url'=>admin_url('sales/view/'.$project_id.'?group=project_estimates'),
            'icon'=>'fa fa-sun-o',
            'lang'=>_l('estimates'),
          ...
          array(
            ...
            'url'=>admin_url('sales/view/'.$project_id.'?group=project_expenses'),
          ...
          array(
            ...
            'url'=>admin_url('sales/view/'.$project_id.'?group=project_credit_notes'),
            'icon'=>'fa fa-sort-amount-asc',
    ...
    array(
        'name'=>'project_notes',
        'url'=>admin_url('sales/view/'.$project_id.'?group=project_notes'),
        'icon'=>'fa fa-clock-o',
    ...
    array(
        ...
        'url'=>admin_url('sales/view/'.$project_id.'?group=project_activity'),
        'icon'=>'fa fa-exclamation',
        'lang'=>_l('project_activity'),
        'visible'=>has_permission('sales', '', 'create'),
        'order'=>11,
 ...
 * @return array
 */
function get_sales_opp_status_by_id($id)
{
    $CI = &get_instance();
    ...
    $statuses = $CI->sales_model->get_project_statuses();
 ...
 * @return array
 */
function get_user_pinned_sales_opp()
{
    $CI = &get_instance();
 ...
 * @return string
 */
function get_sales_opp_name_by_id($id)
{
    $CI =& get_instance();
    ...
    if(!$project){
        $CI->db->select('name');
        $CI->db->where('id', $id);
        $project = $CI->db->get('tblsales')->row();
 ...
 * @return array
 */
function get_sales_opp_milestones($project_id) {
    $CI = &get_instance();
 ...
 * @return mixed
 */
function get_client_id_by_sales_opp_id($id)
{
    $CI =& get_instance();
 ...
 * @return boolean
 */
function customer_has_sales_opp($customer_id)
{
 ...
 * @return mixed
 */
function get_sales_opp_billing_type($project_id)
{
    $CI =& get_instance();
 ...
 * @return array
 */
function get_sales_opp_discussions_language_array()
{
    $lang = array(
