...
{
    return render_custom_fields('items', false, array(), array(
...
{
$CI =& get_instance();
$value_name = $CI->inventory_model->get('tblcustom',false,array('group_type'=>'status','id'=>$id),'value'); 
return $value_name[0]['value'];
}
