...
define('APP_BASE_URL','http://localhost/versipos');
...
define('APP_ENC_KEY','50f57cfc155b830a99533e7b572639e8');
...
define('APP_DB_NAME','versiposcrm');

/* The hostname of your versieats database server. */
define('APP_DB_HOSTNAME_VERSIEATS','localhost');
/* The username used to connect to the database */
define('APP_DB_USERNAME_VERSIEATS','root');
/* The password used to connect to the database */
define('APP_DB_PASSWORD_VERSIEATS','');
/* The name of the database you want to connect to */
define('APP_DB_NAME_VERSIEATS','versieatsdb');
