...
*/
$autoload['libraries'] = array( 'database','form_validation', 'user_agent', 'image_lib', 'encryption', 'object_cache', 'email', 'app', 'gateways/app_gateway', 'sms' );
...
*/
$autoload['model'] = array( 'misc_model' , 'roles_model' , 'clients_model' , 'tasks_model','inventory_model', 'Inventory_items_model' );
