...
if(!defined('SMS_NOT_SEND_DATE_OLDER_THEN')){
...
// sales opportunity files attachments
define('SALE_OPPORTUNITY_ATTACHMENTS_FOLDER',FCPATH . 'uploads/saleopp' . '/');

// Project discussions attachments
define('PROJECT_DISCUSSION_ATTACHMENT_FOLDER',FCPATH . 'uploads/discussions' . '/');

// Project discussions attachments
define('SALEOPP_DISCUSSION_ATTACHMENT_FOLDER',FCPATH . 'uploads/saleoppdiscussions' . '/');
