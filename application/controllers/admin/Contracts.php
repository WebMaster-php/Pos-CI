...
class Contracts extends Admin_controller
{
        ...
        if ($this->input->post()) {
            if ($id == '') {
                ...
                if ($id) {
					...
					$action = 'Contract Subject: "'.$subject.'" Created ';
					$tabname = "contracts";
					$heading = "Company Contracts";
					$this->contracts_history($this->input->post('client'), $action , $tabname, $heading);
    ...
    public function delete($id, $company_id = "")
    {
        ...
        if ($response == true) {
			// HERE;
				...
				$tabname = "contracts";
				$heading = "Company Contracts";
		 	$this->contracts_history($id, $action , $tabname, $heading);
	...
	public function contracts_history($company_id, $action, $tabname, $heading)
