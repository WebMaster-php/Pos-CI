...
class Projects extends Admin_controller
{
    ...
    {
        $this->load->view('admin/projects/show_tasks');
    }
    ...
    // {
        // $this->db->select('name');
		 ...
		 // $this->load->view('admin/projects/show_tasks', $result);
    // }
	...
	public function delete_tasks($id)
    {
		...
		redirect(base_url().'admin/Projects/show_all_tasks');
	}
    ...
    public function project($id = '', $company_id= '')
    {
        ...
        if ($this->input->post()) {
            ...
            if ($id == '') {
                ...
                $id_task = $this->projects_model->add_tasks($id, $product_id);
				// echo "<pre>";print_r($id); die;
                if ($id) {
					 $action = 'Project Name: "'.$data['name'].'" Created ';
					 $tabname= "projects";
					 $heading = "Projects";
					$this->project_history($this->input->post('clientid'), $action, $tabname, $heading );
                ...
                if ($success) {
					 ...
					 $tabname= "projects";
					 $heading = "Projects";
					$this->project_history($company_id, $action, $tabname, $heading );
		...
		/* riz */
        // $data['products_get']              = $this->db->get('tblproducts')->result();
	...
	public function products()
    {
		...
		$this->load->view('admin/projects/products', $data);
	}
	
	public function delete_product()
    {
		$del_id = $this->uri->segment(4); 
		$data['products'] = $this->products_model->delete_product($del_id);
		// $this->load->view('admin/projects/products', $data);
		 redirect('admin/projects/products');
	}
    ...
    public function view($id)
    {
        if ($this->projects_model->is_member($id) || has_permission('projects', '', 'view')) {
            ...
            $data['tasks'] = $this->products_model->getTasksDetails($data['project']->product_id);
	...
	public function project_history($company_id, $action, $tabname, $heading)
	{	
