...
class Estimates extends Admin_controller
{
    ...
    public function estimate($id = '')
    {
        ...
        if ($this->input->post()) {
            ...
            if ($id == '') {
				...
				$estimate_data['portfolio_id'] = $this->session->userdata('portfolio_id');
                $id = $this->estimates_model->add($estimate_data);
                if ($id) {
					
						$action = "Estimate Created";
						$tabname = "estimates";
						$heading = "Company Estimates";
						$this->estimate_history($this->input->post('clientid'), $action, $tabname, $heading);
	...
	public function estimate_history($company_id, $action, $tabname, $heading)
	{
