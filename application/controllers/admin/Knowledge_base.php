...
class Knowledge_base extends Admin_controller
{
    ...
    public function index()
    {
		...
		$portfolio_id = $this->session->userdata('portfolio_id'); // Muneeb Added
		$data['groups'] = $this->knowledge_base_model->get_kbg('','',$portfolio_id);// Muneeb Added
    ...
    public function group($id = '')
    {
        ...
        if ($this->input->post()) {
            ...
            if (!$this->input->post('id')) {
				...
				$post_data['portfolio_id'] = $this->session->userdata('portfolio_id'); // Muneeb Added
