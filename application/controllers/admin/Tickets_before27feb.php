...
class Tickets extends Admin_controller
{
    ...
    // echo "<pre>"; print_r($data['statuses']); exit; 
        ...
        $data['default_tickets_list_statuses'] = do_action('default_tickets_list_statuses', array(1, 2, 3));
    ...
    public function add($userid = false)
    {
      ...
      $array = explode('_', $this->input->post('contactid'), 2);
      if(isset($array[0]))
      {
