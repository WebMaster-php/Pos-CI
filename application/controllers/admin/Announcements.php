...
class Announcements extends Admin_controller
{
    ...
    {
        if(!has_permission('announcement_perm','','create') )
            {
   ...
   //      }
    ...
    public function delete($id)
    {
        ...
        //     access_denied('Announcement');
        // }
        if(!has_permission('announcement_perm','','delete') )
            {
                access_denied('Announcement');
            }
