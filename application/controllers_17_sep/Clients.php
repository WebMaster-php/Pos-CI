				 ...
				 foreach($tick as $ticket){
					...
					$html .= ' <tr class="'.$text.'">
							<td data-order="'.$ticket["ticketid"].'">
									<a href="'.site_url('clients/ticket/'.$ticket["ticketid"]).'" style="color: #333333 !important;"><b> # '.$ticket["ticketid"].'</b></a>		
							</td>
							<td><a href="'.site_url('clients/ticket/'.$ticket["ticketid"]).'" style="color: #333333 !important;" ><b>'.$ticket["subject"].'</b></a></td>
							 <td>
