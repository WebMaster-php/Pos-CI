        ...
        <div class="wrapper">
         ...
         <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h3 class="m-t-0 header-title">Announcements</h3>
							
                           <p class="text-muted m-b-30 font-13">
                                Our approach is to be open-minded and collaborate with the top technology partners to give you the right tools for the job.
                            </p>
