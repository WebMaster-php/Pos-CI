				...
				<div class="row">
				   ...
				   <div class = "row">
					  ...
					  <div class="col-md-3 pull-left">
						<?php 
							echo render_select('userid',$companies,array('userid','company'),'Select Location',(count($companies) == 1) ? $companies[0]['userid'] : '',array('required'=>'true')); ?>
					</div>
					</div>		
					  ...
					  <div class="row">
						 <div class="col-md-6">
							<div class="form-group">
								<?php 
								echo render_select('department',$departments,array('departmentid','name'),'ticket_settings_departments',(count($departments) == 1) ? $departments[0]['departmentid'] : $departments[0]['departmentid'],array('required'=>'true')); ?>
							</div>
						</div>
					</div>
					  ...
					  <div class="col-md-6 col-md-offset-3">
						 <div class="form-group">
							...
							<div class="input-group">
							   ...
							   <button class="btn btn-success add_more_attachments p8-half" style="padding: 10px;" data-ticket="true" type="button"><i class="fa fa-plus"></i></button>
							   </span>
							</div>
						 </div>
					  </div>
