<div class="modal-header">
 <button type="button" class="close" id="page_reload" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
 ...
 <div class="col-md-12">
   ...
   <div class="top-lead-menu">
    ...
    <!--<li role="presentation">
      <a href="#tab_lead_contacts" aria-controls="tab_lead_contacts" role="tab" data-toggle="tab">
...
<div class="tab-content">
  ...
  <div role="tabpanel" class="tab-pane active" id="tab_lead_profile">
   <?php $this->load->view('admin/clients/lead_profile'); ?>
 </div>

 <div role="tabpanel" class="tab-pane active" id="tab_lead_contacts">
   ...
   <div class="inline-block new-contact-wrapper" data-title="<?php echo _l('customer_contact_person_only_one_allowed'); ?>"<?php if($disable_new_contacts){ ?> data-toggle="tooltip"<?php } ?>>
     <a href="#" onclick="lead_contact(<?php echo $id; ?>); return false;" class="btn btn-info new-contact mbot25<?php if($disable_new_contacts){echo ' disabled';} ?>"><?php echo _l('new_contact'); ?></a>
   </div>
 <?php } ?>
 <?php
 ...
 $custom_fields = get_custom_fields('lead_contracts',array('show_on_table'=>1));
 foreach($custom_fields as $field){
   array_push($table_data,$field['name']);
 }
 array_push($table_data,_l('options'));

 echo render_datatable($table_data,'leadscontacts'); ?>
...
<?php $this->load->view('admin/leads/leads_js')?>
<script type="text/javascript">

  $('#tab_lead_contacts').hide();
  var tabContactsCount=0;
  $('a').on('click',function(){
    var contacts_tab=$(this).attr('href');
    if(contacts_tab=='#tab_lead_contacts'){
  ...
  var customer_id='<?php echo $lead->id;?>';
 //alert(customer_id);
  $(function(){
          initDataTable('.table-leadscontacts', admin_url + 'leads/contacts/' + customer_id, '', '');
   });
