    ...
    <div class="row">
      <div class="col-md-12">
            <div class="panel_s">
              ...
              <a href="<?php echo admin_url('sales/project'); ?>" class="btn btn-info pull-left display-block">
                <?php echo _l('New Sales Opportunity'); ?>
              </a>
			  <a href="<?php echo admin_url('sales/products'); ?>" style="margin-left: 10px" class="btn btn-info pull-left display-block">
              ...
              <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
                ...
                <ul class="dropdown-menu dropdown-menu-right width300">
                  <li>
                    <a href="#" data-cview="all" onclick="dt_custom_view('','.table-sales',''); return false;">
                  ...
                  <li>
                    <a href="#" data-cview="my_projects" onclick="dt_custom_view('my_projects','.table-sales','my_projects'); return false;">
                  ...
                  <?php foreach($statuses as $status){ ?>
                    <li class="<?php if($status['filter_default'] == true && !$this->input->get('status') || $this->input->get('status') == $status['id']){echo 'active';} ?>">
                      <a href="#" data-cview="<?php echo 'project_status_'.$status['id']; ?>" onclick="dt_custom_view('project_status_<?php echo $status['id']; ?>','.table-sales','project_status_<?php echo $status['id']; ?>'); return false;">
                ...
                <div class="_filters _hidden_inputs">
                  ...
                  foreach($statuses as $status){
                   $value = $status['id'];
                    ...
                    ?>
					<?php //$where = ($_where == '' ? '' : $_where.' AND ').'status = '.$status['id'] . 'AND portfolio_id = '. $this->session->userdata('portfolio_id') ; ?>
                   <div class="col-md-2 col-xs-6 border-right">
                    ...
                    <a href="#" onclick="dt_custom_view('project_status_<?php echo $status['id']; ?>','.table-projects','project_status_<?php echo $status['id']; ?>',true); return false;">
					 <h3 class="bold"><?php echo total_rows('tblsales',$where); ?></h3>
             ...
             $table_data = array(
              ...
              $custom_fields = get_custom_fields('sales',array('show_on_table'=>1));
...
<script>
$(function(){
     var SalesServerParams = {};
    $.each($('._hidden_inputs._filters input'),function(){
        SalesServerParams[$(this).attr('name')] = '[name="'+$(this).attr('name')+'"]';
    });
     var sales_not_sortable = $('.table-sales').find('th').length - 1;
     initDataTable('.table-sales', admin_url+'sales/table', [sales_not_sortable], [sales_not_sortable], SalesServerParams, <?php echo do_action('sales_table_default_order',json_encode(array(5,'ASC'))); ?>);
