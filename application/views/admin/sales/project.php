            ...
            <div class="col-md-7">
                <div class="panel_s">
                    <div class="panel-body">
                        <h4 class="no-margin">
                            <!--<?php echo $title; ?>-->
							<?php echo "Create a new Sales Opportunity"; ?>
                        </h4>
					...
					<!-------start------->
						  <div class="form-group">
							...
							<option value="">Select Product</option>
                             <?php foreach($products_get as $key=>$o) {?>
                                            <option value="<?php echo $o->id;?>" <?php if($project->product_id==$o->id){?> selected="selected" <?php } ?>>
