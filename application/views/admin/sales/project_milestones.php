<div class="project-toggler-opts">
   ...
   <?php } ?>
   <a href="#" class="btn btn-default" onclick="milestones_switch_view_so(); return false;"><i class="fa fa-th-list"></i></a>
   <?php if($milestones_found) { ?>
   <div id="kanban-params">
      <div class="checkbox mbot20 mtop20">
         <input type="checkbox" value="yes" id="exclude_completed_tasks" name="exclude_completed_tasks"<?php if($milestones_exclude_completed_tasks){echo ' checked';} ?> onclick="window.location.href = '<?php echo admin_url('sales/view/'.$project->id.'?group=project_milestones&exclude_completed='); ?>'+(this.checked ? 'yes' : 'no')">
...
<?php } ?>
<div id="milestones-table1" class="hide mtop25">
