...
if(!null == $CI->session->userdata('portfolio_id')){
    array_push($sWhere,'AND tblemaillists.portfolio_id='.$CI->session->userdata('portfolio_id'));
}

$result           = data_tables_init($aColumns, $sIndexColumn, $sTable, array(), $sWhere, array());
