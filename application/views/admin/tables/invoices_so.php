...
$join = array(
    ...
    'LEFT JOIN tblsales ON tblsales.id = tblinvoices.saleopp_id',
);
...
if ($project_id) {
    ...
    array_push($where, 'AND saleopp_id='.$project_id);
}
...
foreach ($rResult as $aRow) {
    ...
    $row[] = '<a href="'.admin_url('sales/view/'.$aRow['project_id']).'">'.$aRow['project_name'].'</a>';;
