...
{
    array_push($where, 'AND tblreminders.portfolio_id = ' . $CI->session->userdata('portfolio_id') );
}
...
$join = array(
    ...
    'LEFT JOIN tblproposals ON tblproposals.id = tblreminders.rel_id AND tblreminders.rel_type="proposal" AND tblproposals.portfolio_id = 3' ,
