                        <a href="#" class="dropdown-toggle notifications-icon" data-toggle="dropdown" aria-expanded="false">
                          <i class="fa fa-bell-o fa-fw fa-lg"></i>
                           ...
                           <?php 
                            ...
                            $not   = total_rows('tblnotifications', array(
                          ...
                          <span class="label icon-total-indicator bg-warning icon-notifications"><?php echo $not; ?></span>
                          <?php } ?>
                        </a>
                        <ul class="dropdown-menu notifications animated fadeIn width400" data-total-unread="<?php echo $not; ?>">
