   ...
   <nav>
      ...
      <ul class="nav navbar-nav navbar-right">
         ...
         <li class="icon header-newsfeed">
            <a href="#" class="open_newsfeed" data-toggle="tooltip" title="<?php echo _l('whats_on_your_mind'); ?>" data-placement="bottom"><i class="fa fa-share fa-fw fa-lg" aria-hidden="true"></i>
            </a>
         </li>
         <?php } ?>
         <li class="icon header-todo">
            <a href="<?php echo admin_url('todo'); ?>" data-toggle="tooltip" title="<?php echo _l('nav_todo_items'); ?>" data-placement="bottom"><i class="fa fa-check-square-o fa-fw fa-lg"></i>
              ...
              $dat   = total_rows('tbltodoitems', array(
                        'finished' => 0,
               ...
               ?> 
            <span class="label bg-warning icon-total-indicator nav-total-todos<?php if($dat == 0){echo ' hide';} ?>"><?php echo $dat; ?></span>
            </a>
         </li>
