  ...
  <div class="modal-dialog" id="error_by1" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"> <span class="add-title" id="titleModal"><?php echo _l('inventory_add'); ?></span> </h4>
      </div>
      <div class="modal-body">
        ...
        <form enctype="multipart/form-data" id="formPost" method="post">
          ...
          <div class = "col-md-12">
            ...
            <div class="col-md-6">
              <div class="form-group" app-field-wrapper="serial_number">
                <label for="serial_number" class="control-label">Serial Number</label>
                <input type="text" id="serial_number" onfocus="if(this.value == 'value'){ this.value = ''; }" name="serial_number" class="form-control">
              </div>
            </div>
          </div>
          <div class = "col-md-12">
...
if($value->group_type == 'status'){?>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="selectpicker display-block" data-width="100%" name="origin" id="origin" data-none-selected-text="<?php echo _l('origin'); ?>">
                  <option value=""></option>
                  <?php foreach($values as $value){ 
