         ...
         <div class="col-md-6">
            <div id="customers_records">
              <div class="form-group">
                  ...
                  <p id="check_error" class="text-danger" style="display: none;">Already exist in leads</p>
              </div>
            </div>
            <div class="clearfix20"></div>

            <?php $value = (isset($lead) ? $lead->name : ''); ?>
           <div id="new_company"> <?php echo render_input('name','Company Name',$value); ?> </div>
