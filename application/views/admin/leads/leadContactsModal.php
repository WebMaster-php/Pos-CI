...
<div class="modal fade" id="lead_contacts" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php echo form_open('admin/leads/contact/'.$customer_id.'/'.$contactid,array('id'=>'lead_contact_form','autocomplete'=>'off')); ?>
				...
				<!-- <div class="row">
					...
					<div class="col-md-2 mtop10">
						<div class="onoffswitch">
							<input type="checkbox" id="existing_contact" class="onoffswitch-checkbox" value="0" name="existing_contact">
							<label class="onoffswitch-label" for="existing_contact"></label>
						</div>
					</div>
				</div> -->
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
						<div id="new_contact">
							...
							<?php echo render_input( 'first_name', 'client_firstname',$value); ?>
							<?php $value=( isset($contact) ? $contact->last_name : ''); ?>
							<?php echo render_input( 'last_name', 'client_lastname',$value); ?>
							<?php $value=( isset($contact) ? $contact->title : ''); ?>
							<?php echo render_input( 'title', 'contact_position',$value); ?>
							<?php $value=( isset($contact) ? $contact->lead_email : ''); ?>
							<?php echo render_input( 'lead_email', 'client_email',$value, 'email'); ?>
							<?php $value=( isset($contact) ? $contact->lead_phonenumber : ''); ?>
							<?php echo render_input( 'lead_phonenumber', 'client_phonenumber',$value,'text',array('autocomplete'=>'off')); ?>
						...
						<div class="form-group">
							...
							<select class="selectpicker display-block"   data-live-search="true" data-width="100%" class="ajax-search" id="old_existing_account" name="old_existing_account" data-none-selected-text="<?php echo _l('Please Choose Customer'); ?>">
								...
								<?php foreach($contactsdata as $contdata){?>
									<option value="<?php echo $contdata->id; ?>" ><?php echo $contdata->first_name.' '.$contdata->last_name;?></option>
								<?php } ?>
							</select>
