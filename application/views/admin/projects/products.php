      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
           ...
           <div class="_buttons">
		   <a href="#" class="btn btn-info pull-left" data-toggle="modal" data-target="#sales_item_modal"><?php echo _l('create a new product'); ?></a>
			   <a href="<?php echo admin_url('projects/project'); ?>" class="btn btn-info pull-left" style="    margin-left: 5px;">Create a new project</a>
              ...
              <?php foreach($products as $group){ ?>
                <tr data-group-row-id="<?php echo $group['id']; ?>">
                  <td data-order="<?php echo $group['description']; ?>">
                    <a href="#" data-toggle="modal" data-target="#sales_item_modal" data-id="<?php echo $group['id']; ?>"><?php echo $group['description']; ?></a>
                  </td>
                  <td>
