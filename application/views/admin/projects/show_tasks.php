      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
           ...
           <div class="_buttons">
		 <!--  <a href="<?php echo admin_url('projects/'); ?>" class="btn btn-info pull-left"><?php echo _l('Back to projects'); ?></a> -->
			  
		  <!-- <a href="<?php echo admin_url('sales/'); ?>" class="btn btn-info pull-left"><?php echo _l('Back to sales opportunities'); ?></a> -->
			   
			   <a href="<?php echo admin_url('projects/'); ?>" class="btn btn-info pull-left" style="    margin-left: 5px;">Back to projects</a>
       <a href="<?php echo admin_url('sales/'); ?>" class="btn btn-info pull-left" style="    margin-left: 5px;">Back to sales opportunities</a>
          ...
          $table_data = array(
			...
			// $this->db->select('name');
			// $old_status = $this->db->get('tblstafftasks')->result_array();
			// echo "<pre>".'ssss'; print_r($old_status); die;
			...
			<table class="table dt-table table-items-groups" data-order-col="0" data-order-type="asc">
			  ...
			  // print_r($tasks);
			  ?>
                <tr data-group-row-id="<?php echo $tasks['id']; ?>">
                  <td data-order="<?php echo $tasks['id']; ?>">
                    <a href="#" data-toggle="modal" data-target="#sales_item_modal" data-id="<?php echo $tasks['id']; ?>"><?php echo $tasks['name']; ?></a>
                  </td>
                  <!--<td>
                  ...
                  <td align="right">
                    <!--<a href="admin/#<?php //echo $group['id']; ?>" class="btn btn-default btn-icon" data-toggle="modal" data-target="#sales_item_modal" data-id="<?php //echo $group['id']; ?>"><i class="fa fa-pencil-square-o"></i></a>-->
                    <a href="delete_tasks/<?php echo $tasks['id']; ?>" class="btn btn-danger _delete btn-icon"><i class="fa fa-remove"></i></a></td>
                   </tr>
              <?php } ?>
              </tbody>
            </table>
...
<?php //$this->load->view('admin/invoice_items/product_items'); ?>
         ...
         <div class="container-fluid">
          <table class="table dt-table table-items-groups" data-order-col="0" data-order-type="asc">
            ...
            <tbody>
			 ...
			 // echo "<pre>"; print_r($items_groups); die;
