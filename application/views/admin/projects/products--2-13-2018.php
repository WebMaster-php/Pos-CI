      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
           ...
           <div class="_buttons">
		   <a href="#" class="btn btn-info pull-left" data-toggle="modal" data-target="#sales_item_modal"><?php echo _l('new products'); ?></a>
              ...
              <?php foreach($products as $group){ ?>
                <tr data-group-row-id="<?php echo $group['id']; ?>">
                  ...
                  <td align="right">
                    ...
                    <a href="products/delete_product/<?php echo $group['id']; ?>" class="btn btn-danger _delete btn-icon"><i class="fa fa-remove"></i></a></td>
                   </tr>
              <?php } ?>
              </tbody>
            </table>
