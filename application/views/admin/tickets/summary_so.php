...
foreach($statuses as $status){
  ...
  if(isset($project_id)){
    ...
    $_where = $_where . ' AND saleopp_id='.$project_id;
  }
  ?>
  <div class="col-md-2 col-xs-6 mbot15 border-right">
    <a href="#" data-cview="ticket_status_<?php echo $status['ticketstatusid']; ?>" onclick="dt_custom_view('ticket_status_<?php echo $status['ticketstatusid']; ?>','.tickets-table-so','ticket_status_<?php echo $status['ticketstatusid']; ?>',true); return false;">
