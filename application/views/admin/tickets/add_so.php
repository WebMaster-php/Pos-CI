					...
					<div class="panel-body">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group projects-wrapper hide">
									...
									<div id="project_ajax_search_wrapper">
										<select name="project_id" id="project_id" class="projects ajax-search" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"<?php if(isset($project_id)){ ?> data-auto-project="true" data-project-userid="<?php echo $userid; ?>"<?php } ?>>
											...
											<option value="" selected><?php echo '#'.$project_id. ' - ' . get_sales_opp_name_by_id($project_id); ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
								...
								<div class="form-group projects-wrapper hide">
									<label for="saleopp_id"><?php echo _l('project'); ?></label>
									<div id="project_ajax_search_wrapper1">
										<select name="saleopp_id" id="saleopp_id" class="projects ajax-search" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"<?php if(isset($saleopp_id)){ ?> data-auto-project="true" data-project-userid="<?php echo $userid; ?>"<?php } ?>>
											<?php if(isset($saleopp_id)){ ?>
											<option value="<?php echo $saleopp_id; ?>" selected><?php echo '#'.$saleopp_id. ' - ' . get_sales_opp_name_by_id($saleopp_id); ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
