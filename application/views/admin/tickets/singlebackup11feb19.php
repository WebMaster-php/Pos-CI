										...
										<tbody>
											<?php foreach($client as $clients){ ?>
												<tr>
													...
													<!-- <td><?php //if ($clients['active'] == '1') ?><div class="onoffswitch">
														<input type="checkbox" data-switch-url="http://localhost/versipos/admin/clients/change_contact_status" name="onoffswitch" class="onoffswitch-checkbox" id="c_25" data-id="25" checked="">
														<label class="onoffswitch-label" for="c_25"></label></td> -->
														<!-- <td><?php //echo  date('m-d-Y  h:i A', strtotime($clients['last_login'])); ?></td> -->
