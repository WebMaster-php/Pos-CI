...
<div class="tab-content">
  ...
  <div role="tabpanel" class="tab-pane" id="tasks">
      ...
      <div>
          <label><i class="fa fa-question-circle pull-left"></i>Daily Reminders</label>
          <br>
          <input type="radio" name="settings[daily_reminder_tasks_cron]" value="1" <?php echo (get_option('daily_reminder_tasks_cron')==1)?'checked':''  ?>>Yes
          <input type="radio" name="settings[daily_reminder_tasks_cron]" value="0" <?php echo (get_option('daily_reminder_tasks_cron')==0)?'checked':''  ?>>No
          <br>
          <br>
      </div>
