      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
		   ...
		   <?php } if(getAdmin() || has_permission('inventory_items', '', 'view') && has_permission('inventory_items', '', 'create') && has_permission('inventory_items', '', 'edit') && has_permission('inventory_items', '', 'delete') ){ ?>
		  ...
		  <?php 
		  if (getAdmin() || has_permission('inventory_items', '', 'edit') || has_permission('inventory_items', '', 'delete') ) 
		  {
				$table_data = array(
					_l('serial_number'),
					_l('type_Of_hardware'),
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php if(has_permission('inventory_items','','create')){ ?>
         ...
         <div class="container-fluid">
          <table class="table dt-table table-items-groups" data-order-col="0" data-order-type="asc">
            ...
            <tbody>
              ...
              <td align="right">
                <?php if(has_permission('inventory_items','','edit')){ ?><button type="button" class="btn btn-default btn-icon edit-item-group"><i class="fa fa-pencil-square-o"></i></button><?php } ?>
                <?php if(has_permission('inventory_items','','delete')){ ?><a href="<?php echo admin_url('inventory/delete_group/'.$value->id); ?>" class="btn btn-danger btn-icon delete-item-group _delete"><i class="fa fa-remove"></i></a><?php } ?></td>
              </tr>
              <?php } }?>
            </tbody>
          </table>
