					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-8">
								...
								<p><?php echo '<b>'.$ticket->firstname.' '.$ticket->lastname.'<b>'.' - '.$ticket->phonenumber. ' - '.date('m/d/Y',strtotime($ticket->date)); ?></p>
							</div>
								...
								<div>
									...
									<div class="panel_s ticket-reply-tools">
										...
										<div class="panel-body">
											<div class="row">
												<div class="col-md-5">
													<?php echo render_select('status',$statuses,array('ticketstatusid','name'),'ticket_single_change_status',get_option('default_ticket_reply_status'),array(),array(),'','',false); //exit;?>
