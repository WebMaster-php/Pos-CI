...
<div class="team-members project-overview-team-members">
   ...
   <div class="media">
      ...
      <div class="media-body">
         <?php if(has_permission('sales','','edit') || has_permission('sales','','create')){ ?>
         <a href="<?php echo admin_url('sales/remove_team_member/'.$project->id.'/'.$member['staff_id']); ?>" class="pull-right text-danger _delete"><i class="fa fa fa-times"></i></a>
         <?php } ?>
