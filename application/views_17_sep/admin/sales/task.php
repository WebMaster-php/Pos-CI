  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="row">
	  ...
	  <!--imran arshad changes strart -->
        ...
        if($task->hard_date =='' ){
            ?>
            <p  style="float: right; margin-bottom: 0px;padding-bottom: 0px;"><input type="checkbox" name="hard_date" value="1" <?php echo ($task->hard_date==1)?'checked':'' ?>>Hard Due Date?</p>
            <?php
        }else{
         $currentUserId = $clientRequest == false ? get_staff_user_id() : get_contact_user_id();
        if($currentUserId != $task->addedfrom &&  $task->addedfrom !='' &&  $task->hard_date !=''  &&  $task->hard_date ==1 ) {
            ...
            <p style="float: right; margin-bottom: 0px;padding-bottom: 0px;"><input type="checkbox" name="hard_date"
                                                                                    value="1" <?php echo ($task->hard_date == 1) ? 'checked' : '' ?> <?= $disabled ?>>Hard
                Due Date?</p>
            <?php
