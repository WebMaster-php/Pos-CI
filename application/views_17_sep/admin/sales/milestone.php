...
<div class="modal fade" id="milestone" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('sales/milestone'),array('id'=>'milestone_form')); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_input('milestone_order','project_milestone_order',total_rows('tblmilestonesso',array('project_id'=>$project->id)) + 1,'number'); ?>
                    </div>
                </div>
            </div>
