...
<a href="#" onclick="new_discussion_so();return false;" class="btn btn-info mbot25"><?php echo _l('new_project_discussion'); ?></a>

<?php 
    $this->load->view('admin/sales/project_discussion');
...
<p><?php echo _l('project_discussion_total_comments'); ?>: <?php echo total_rows('tblsalediscussioncomments',array('discussion_id'=>$discussion->id)); ?>
