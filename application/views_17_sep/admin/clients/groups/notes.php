...
<div class="row">
 ...
 <div class="usernote hide">
    <?php echo form_open(admin_url( 'misc/add_note/'.$client->userid.'/customer')); ?>	
		<div class="checkbox" style="position:  absolute; top: 10px; left:  130px;">
			<input type="checkbox" value="internal" name="viewcheck" id = "internal" checked onclick = "myFunctioninternal()"/> 
			<label>Internal</label>
		</div>	
		<div class="checkbox" style="position: absolute; top: 25px;  left: 220px;">
			<input type="checkbox" value="external" name="viewcheck" id = "external" onclick = "myFunctionexternal()"/>
    ...
    <table class="table dt-table scroll-responsive" data-order-col="2" data-order-type="desc">
        ...
        <tbody>
            ...
            <tr>
                ...
                </div><?php $company_id = $this->uri->segment(4);?>
                <div data-note-edit-textarea="<?php echo $note['id']; ?>" class="hide">
                    ...
                    <div class="text-right mtop15">
                      <button type="button" class="btn btn-default" onclick="toggle_edit_note(<?php echo $note['id']; ?>, <?php echo $company_id;?>);return false;"><?php echo _l('cancel'); ?></button>
                      <button type="button" class="btn btn-info" onclick="edit_note(<?php echo $note['id']; ?>, <?php echo $company_id;?>);"><?php echo _l('update_note'); ?></button>
                  </div>
              </div>
          </td>
          <td>
        ...
        <td>
            ...
            <a href="<?php echo admin_url('misc/delete_note/'. $note['id'].'/'. $company_id); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
            <?php } ?>
        </td>
    </tr>
    <?php } ?>
