...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
						...
						<div class="form-group">
							...
							<select class="selectpicker display-block"   data-live-search="true" data-width="100%" class="ajax-search" id="old_existing_account" name="old_existing_account" data-none-selected-text="<?php echo _l('Please Choose Customer'); ?>">
								...
								<?php foreach($contactsdata as $contdata){?>
									<option value="<?php echo $contdata->id; ?>" ><?php echo $contdata->firstname.' '.$contdata->lastname;?></option>
								<?php } ?>
							</select>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" id ="existing_contact_save" class="btn btn-info" data-loading-text="Please wait..." autocomplete="off" data-form="#contact-form"><?php echo _l('submit'); ?></button>
    </div>
    <?php echo form_close(); ?>
		</div>
	</div>
