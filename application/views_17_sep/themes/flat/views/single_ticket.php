...
<div class="row">
    ...
    <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="ticket-status-inline">
                                    <span class="badge badge-success pull-right bold" style="background:<?php echo $ticket->statuscolor; ?>">
        ...
        <div class="panel_s">
            <div class="panel-heading">
                <b><?php echo _l('clients_single_ticket_string'); ?></b>
            </div>
            <div class="panel-body <?php if($ticket->admin == NULL){echo 'client-reply';} ?>">
                <div class="row">
                    <div class="col-md-12">
						<?php if($ticket->admin == NULL || $ticket->admin == 0){ ?>
                        <p><b><?php echo $ticket->submitter; ?></b></p>
                        <?php } else { ?>
                        <p><b><?php echo $ticket->opened_by; ?></b></p>
                        <p class="text-muted">
                            <b><?php echo _l('ticket_staff_string'); ?></b>
                        </p>
                        <?php } ?>
    ...
    <div class="panel_s">
        <div class="panel-body <?php if($reply['admin'] == NULL){echo 'client-reply';} ?>">
            <div class="row">
                <div class="col-md-12">
					<p><b><?php echo $reply['submitter']; ?></b></p>
