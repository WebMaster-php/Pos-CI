				...
				<div class="row">
				   ...
				   <div class = "row">
					  ...
					  <div class="col-md-3 pull-left">
						...
						<select required class="selectpicker display-block" data-live-search="true" data-width="100%" class="ajax-search" id="select_business" name =  "userid" data-none-selected-text="<?php echo _l('Please Choose Company'); ?>">
							<option value=""></option>
