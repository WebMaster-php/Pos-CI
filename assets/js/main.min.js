...
function mainWrapperHeightFix() {
    var e = side_bar.height(),
        t = $(".content").height();
    setup_menu.css("min-height", $(document).outerHeight(!0) - 126 + "px"), content_wrapper.css("min-height", $(document).outerHeight(!0) - 63 + "px"), t < e &&
        content_wrapper.css("min-height", e + "px"), t < e && e < $(window).height() && content_wrapper.css("min-height", $(window).height() - 63 + "px"), t >
        e && t < $(window).height() && content_wrapper.css("min-height", $(window).height() - 63 + "px"), is_mobile() && "true" == isRTL && side_bar.css(
            "min-height", $(document).outerHeight(!0) - 63 + "px")
}
...
function generatePassword(e) {
    for (var t = "abcdefghijklnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", a = "", i = 0, n = t.length; i < 12; ++i) a += t.charAt(Math.floor(Math.random() *
        n));
...
function alert_float(e, t) {
    var a, i;
    a = $("body").find("float-alert").length, a = "alert_float_" + ++a, i = $('<div id="' + a +
        '" class="float-alert animated fadeInRight col-xs-11 col-sm-4 alert alert-' + e +
        '"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><span class="fa fa-bell-o" data-notify="icon"></span><span class="alert-title">' +
        t + "</span></div>"), $("body").append(i), setTimeout(function() {
...
//bilal code start
function init_rel_tasks_table_so(e, t, a) {
    void 0 === a && (a = ".table-rel-tasks-saleopp");
    var i = $("body").find(a);
    if (0 != i.length) {
        var n, s, o = {};
        s = $("._hidden_inputs._filters._tasks_filters input"), $.each(s, function() {
        ...
        var l = admin_url + "tasks/init_relation_tasks/" + e + "/" + t;
        n = [i.find("th").length - 1], "saleopp" == i.attr("data-new-rel-type") && (n.push(0), l += "?bulk_actions=true");
        var d = initDataTable(i, l, n, n, o, [i.find("th.duedate").index(), "ASC"]);
        d && "lead" == t && d.column($("table .table-tasks-options").index()).visible(!1, !1).columns.adjust()
    }
}
...
function get_dt_export_buttons(e) {
    if (("persian" == app_language.toLowerCase() || "arabic" == app_language.toLowerCase()) && 0 == $("body").find("#amiri").length) {
        ...
        t.setAttribute("src", "https://rawgit.com/xErik/pdfmake-fonts-google/master/build/script/ofl/amiri.js"), t.setAttribute("id", "amiri"), document.head.appendChild(
            t);
            ...
            buttons: [{
                ...
                customize: function(t) {
                    ...
                    setTimeout(function() {
                        ...
                        }, 10), "persian" != app_language.toLowerCase() && "arabic" != app_language.toLowerCase() || (t.defaultStyle.font =
                            Object.keys(pdfMake.fonts)[0]), t.styles.tableHeader.alignment = "left", t.styles.tableHeader.margin = [5, 5, 5, 5],
...
function table_export_button_is_hidden() {
    return "to_all" != app_show_table_export_button && ("hide" == app_show_table_export_button || "only_admins" == app_show_table_export_button && 0 ==
        is_admin)
}
...
function initDataTableInline(e) {
    ...
    if (0 != a.length) {
        var i = [10, 25, 50, 100],
            n = [10, 25, 50, 100];
        if (app_tables_pagination_limit = parseFloat(app_tables_pagination_limit), -1 == $.inArray(app_tables_pagination_limit, i) && (i.push(
                app_tables_pagination_limit), n.push(app_tables_pagination_limit)), i.sort(function(e, t) {
                return e - t
            }), n.sort(function(e, t) {
                return e - t
            ...
            var s, o, l = {
                    ...
                    fnDrawCallback: function(e) {
                        _table_jump_to_page(this, e), 0 == e.aoData.length || 0 == e.aiDisplay.length ? $(e.nTableWrapper).addClass("app_dt_empty") : $(e.nTableWrapper)
                            .removeClass("app_dt_empty")
                    },
                    initComplete: function(e, a) {
                        var i = this.find(".dataTables_empty");
                        (this.hasClass("scroll-responsive") || 1 == app_scroll_responsive_tables) && this.wrap('<div class="table-responsive"></div>'), i.length &&
                            i.attr("colspan", this.find("thead th").length), this.parents(".table-loading").removeClass("table-loading");
                        var n = $(t),
                            s = n.find("thead th:last-child"),
                            o = n.find("thead th:first-child");
                        s.text().trim() == appLang.options && s.addClass("not-export"), o.find('input[type="checkbox"]').length > 0 && o.addClass(
                            "not-export")
                    },
            ...
            $.each(a, function() {
                $(this).addClass("dt-no-serverside"), s = l, ($(this).hasClass("scroll-responsive") || 1 == app_scroll_responsive_tables) && (s.responsive = !
                    1), d = $(this).attr("data-order-col"), r = $(this).attr("data-order-type"), d && r && (s.order = [
                    [d, r]
...
function initDataTable(e, t, a, i, n, s) {
    ...
    var l = [10, 25, 50, 100],
        d = [10, 25, 50, 100];
    app_tables_pagination_limit = parseFloat(app_tables_pagination_limit), -1 == $.inArray(app_tables_pagination_limit, l) && (l.push(
        app_tables_pagination_limit), d.push(app_tables_pagination_limit)), l.sort(function(e, t) {
        return e - t
    }), d.sort(function(e, t) {
        return e - t
    ...
    var r = {
        ...
        fnDrawCallback: function(e) {
            _table_jump_to_page(this, e), 0 == e.aoData.length ? $(e.nTableWrapper).addClass("app_dt_empty") : $(e.nTableWrapper).removeClass(
                "app_dt_empty")
        },
        ...
        initComplete: function(e, t) {
            var a = this;
            (a.hasClass("scroll-responsive") || 1 == app_scroll_responsive_tables) && a.wrap('<div class="table-responsive"></div>');
            var i = a.find(".dataTables_empty");
            i.length && i.attr("colspan", a.find("thead th").length), is_mobile() && $(window).width() < 400 && a.find(
                'tbody td:first-child input[type="checkbox"]').length > 0 && (a.DataTable().column(0).visible(!1, !1).columns.adjust(), $(
                "a[data-target*='bulk_actions']").addClass("hide")), a.parents(".table-loading").removeClass("table-loading"), a.removeClass(
                "dt-table-loading");
            var n = a.find("thead th:last-child"),
                s = a.find("thead th:first-child");
            n.text().trim() == appLang.options && n.addClass("not-export"), s.find('input[type="checkbox"]').length > 0 && s.addClass("not-export"),
    ...
    }, 10), o.is(":hidden") && o.find(".dataTables_empty").attr("colspan", o.find("thead th").length), $(document).on("change", ".dt-page-jump-select",
        function() {
...
function update_todo_items() {
    ...
    }), 0 == e.length ? ($(".nav-total-todos").addClass("hide"), $(".unfinished-todos li.no-todos").removeClass("hide")) : e.length > 0 && ($(
        ".unfinished-todos li.no-todos").hasClass("hide") || $(".unfinished-todos li.no-todos").addClass("hide"), $(".nav-total-todos").removeClass(
        "hide").html(e.length)), x = 1, $.each(t, function() {
        $(this).find('input[name="todo_order"]').val(x), $(this).find('input[name="finished"]').val(1), $(this).find('input[type="checkbox"]').prop(
            "checked", !0), a++, x++
    }), 0 == t.length ? $(".finished-todos li.no-todos").removeClass("hide") : t.length > 0 && ($(".finished-todos li.no-todos").hasClass("hide") || $(
        ".finished-todos li.no-todos").addClass("hide"));
    var i = [];
    $.each(e, function() {
        var e = $(this).find(".todo-description");
        e.hasClass("line-throught") && e.removeClass("line-throught"), $(this).find('input[type="checkbox"]').prop("checked", !1), i.push([$(this).find(
            'input[name="todo_id"]').val(), $(this).find('input[name="todo_order"]').val(), $(this).find('input[name="finished"]').val()])
    }), $.each(t, function() {
        var e = $(this).find(".todo-description");
        e.hasClass("line-throught") || e.addClass("line-throught"), i.push([$(this).find('input[name="todo_id"]').val(), $(this).find(
            'input[name="todo_order"]').val(), $(this).find('input[name="finished"]').val()])
...
function init_roles_permissions(e, t) {
    if (e = void 0 === e ? $('select[name="role"]').val() : e, !($('.member > input[name="isedit"]').length > 0 && void 0 !== e && void 0 === t) && !0 !== $(
            'input[name="administrator"]').prop("checked") && "" != e) {
        ...
        requestGetJSON("misc/get_role_permissions_ajax/" + e).done(function(e) {
            ...
            $.each(a, function() {
                ...
                0 == e.length && n.find('input[type="checkbox"]').prop("checked", !1), $.each(e, function(e, s) {
                    a == s.permissionid && (t = 1 == s.can_view, i = 1 == s.can_view_own, n.find("[data-can-view]").prop("checked", t),
                        1 == t && n.find("[data-can-view]").change(), n.find("[data-can-view-own]").prop("checked", i), 1 == i && n
                        .find("[data-can-view-own]").change(), n.find("[data-can-edit]").prop("checked", 1 == s.can_edit), n.find(
                            "[data-can-create]").prop("checked", 1 == s.can_create), n.find("[data-can-delete]").prop("checked", 1 ==
                            s.can_delete))
                })
            })
        })
...
function toggle_small_view(e, t) {
    ...
    if (0 != a.length) {
        var i = !1;
        a.hasClass("col-md-5") ? (a.removeClass("col-md-5").addClass("col-md-12"), i = !0, $(".toggle-small-view").find("i").removeClass(
            "fa fa-angle-double-right").addClass("fa fa-angle-double-left")) : (a.addClass("col-md-5").removeClass("col-md-12"), $(".toggle-small-view").find(
            "i").removeClass("fa fa-angle-double-left").addClass("fa fa-angle-double-right"));
        var n = $(e).DataTable();
...
function init_editor(e, t) {
    ...
    if (0 != a.length) {
        ...
        var i = {
            ...
            plugins: ["advlist autoresize autosave lists link image print hr codesample",
                "searchreplace wordcount visualblocks visualchars code fullscreen", "media save table contextmenu", "paste textcolor colorpicker"
            ],
...
function init_btn_with_tooltips() {
    if (is_mobile()) {
        ...
        $.each(t, function() {
            var e = $(this).attr("title");
            void 0 === e && (e = $(this).attr("data-title")), void 0 !== e && ($(this).find(".btn").eq(0).append(" " + e), $(this).removeClass(
...
function edit_reminder(e, t) {
    requestGetJSON("misc/get_reminder/" + e).done(function(t) {
        ...
        0 === a.length && $("body").hasClass("all_reminders") && ((a = $(".reminder-modal--")).find('input[name="rel_type"]').val(t.rel_type), a.find(
            'input[name="rel_id"]').val(t.rel_id)), a.find("form").attr("action", admin_url + "misc/edit_reminder/" + e), a.find("#description").val(
            t.description), a.find("#date").val(t.date), a.find("#staff").selectpicker("val", t.staff), a.find("#notify_by_email").prop("checked",
            1 == t.notify_by_email), a.modal("show")
    })
}
...
function reminderFormHandler(e) {
    ...
    }), $("body").hasClass("all_reminders") ? $(".reminder-modal--").modal("hide") : $(".reminder-modal-" + e.find('[name="rel_type"]').val() + "-" + e.find(
        '[name="rel_id"]').val()).modal("hide"), !1
}
...
function edit_note(e,f = '') {
    var t = $("body").find('[data-note-edit-textarea="' + e + '"] textarea').val();
    "" != t && ($.post(admin_url + "misc/edit_note/" + e +'/'+ f, {
        description: t
    }).done(function(a) {
...
function toggle_file_visibility(e, t, a) {
    requestGet("misc/toggle_file_visibility/" + e).done(function(e) {
        1 == e ? $(a).find("i").removeClass("fa fa-toggle-off").addClass("fa fa-toggle-on") : $(a).find("i").removeClass("fa fa-toggle-on").addClass(
            "fa fa-toggle-off")
    })
}
...
function kanban_load_more(e, t, a, i, n) {
    ...
    if (d <= r) {
        ...
        0 != c.length && "" != c.val() && (o.sort_by = c.val(), o.sort = _), void 0 !== l && "" != l && (o.search = l), $.each($("#kanban-params input"),
            function() {
                "" != (s = "checkbox" == $(this).attr("type") ? !0 === $(this).prop("checked") ? $(this).val() : "" : $(this).val()) && (o[$(this).attr(
                    "name")] = s)
...
function check_kanban_empty_col(e) {
    ...
    $.each(t, function(t, a) {
        0 == $(a).find(e).length ? ($(a).find(".kanban-empty").removeClass("hide"), $(a).find(".kanban-load-more").addClass("hide")) : $(a).find(
            ".kanban-empty").addClass("hide")
    })
}
...
function init_kanban(e, t, a, i, n, s) {
    if (0 != $("#kan-ban").length) {
        ...
        $.each($("#kanban-params input"), function() {
            "" != (o = "checkbox" == $(this).attr("type") ? !0 === $(this).prop("checked") ? $(this).val() : "" : $(this).val()) && (l[$(this).attr(
                "name")] = o)
        });
            ...
            $("body").append('<div class="dt-loader"></div>'), $("#kan-ban").load(e, function() {
                ...
                void 0 !== s && s(), $(".status").sortable({
                    ...
                    sort: function(e, t) {
                        ...
                        var i = $(a).offset();
                        i.top + a.offsetHeight - e.pageY < 20 ? a.scrollTop = a.scrollTop + 60 : e.pageY - i.top < 20 && (a.scrollTop =
                                a.scrollTop - 60), i.left + a.offsetWidth - e.pageX < 20 ? a.scrollLeft = a.scrollLeft + 60 : e.pageX -
                            i.left < 20 && (a.scrollLeft = a.scrollLeft - 60)
                    },
                    change: function() {
                    ...
                    start: function(e, t) {
                        $("body").css("overflow", "hidden"), $(t.helper).addClass("tilt"), $(t.helper).find(".panel-body").css(
                            "background", "#fbfbfb"), tilt_direction($(t.helper))
                    },
                    stop: function(e, t) {
                        $("body").removeAttr("style"), $(t.helper).removeClass("tilt"), $("html").off("mousemove", $(t.helper).data(
                            "move_handler")), $(t.helper).removeData("move_handler")
                    },
                    update: function(e, a) {
                        t(a, this)
                    }
    ...
    "undefined" == typeof newsFeedDropzone && $("body").on("submit", "#new-post-form", function() {
        return $.post(this.action, $(this).serialize()).done(function(e) {
            if ((e = JSON.parse(e)).postid) {
                if (newsFeedDropzone.getQueuedFiles().length > 0) return newsFeedDropzone.options.url = admin_url +
                    "newsfeed/add_post_attachments/" + e.postid, void newsFeedDropzone.processQueue();
        ...
        success: function(e, t) {
            0 === this.getUploadingFiles().length && 0 === this.getQueuedFiles().length && (newsfeed_new_post((t = JSON.parse(t)).postid),
                clear_newsfeed_post_area(), this.removeAllFiles())
        }
    }))
}
...
function add_comment(e) {
    ...
    $.post(admin_url + "newsfeed/add_comment", {
        ...
        1 == (a = JSON.parse(a)).success && ($(e).val(""), $("body").find('[data-comments-postid="' + t + '"] .post-comment').length > 0 ? $("body").find(
            '[data-comments-postid="' + t + '"] .post-comment').prepend(a.comment) : refresh_post_comments(t))
    })
}
...
function _gen_lead_add_inline_on_select_field(e) {
    var t = "";
    ($("body").hasClass("leads-email-integration") || $("body").hasClass("web-to-lead-form")) && (e = "lead_" + e), t = '<div id="new_lead_' + e +
        '_inline" class="form-group"><label for="new_' + e + '_name">' + $('label[for="' + e + '"]').html().trim() +
        '</label><div class="input-group"><input type="text" id="new_' + e + '_name" name="new_' + e +
        '_name" class="form-control"><div class="input-group-addon"><a href="#" onclick="lead_add_inline_select_submit(\'' + e +
        '\'); return false;" class="lead-add-inline-submit-' + e + '"><i class="fa fa-check"></i></a></div></div></div>', $(".form-group-select-input-" + e).after(
            t), $('.lead-save-btn,#form_info button[type="submit"],#leads-email-integration button[type="submit"],.btn-import-submit').prop("disabled", !0), $(
            ".inline-field-new").addClass("disabled").css("opacity", .5), $(".form-group-select-input-" + e).addClass("hide")
}
    ...
    if ("" != t) {
        ...
        i.name = t, i.inline = !0, $.post(admin_url + "leads/" + a, i).done(function(a) {
            if (1 == (a = JSON.parse(a)).success) {
                ...
                i.append('<option value="' + a.id + '">' + t + "</option>"), i.selectpicker("val", a.id), i.selectpicker("refresh"), i.parents(
                    ".form-group").removeClass("has-error")
            }
        })
    }
    $("#new_lead_" + e + "_inline").remove(), $(".form-group-select-input-" + e).removeClass("hide"), $(
...
function lead_profile_form_handler(e) {
    ...
    return $(".lead-save-btn").addClass("disabled"), $.post(e.attr("action"), t).done(function(e) {
        "" != (e = JSON.parse(e)).message && alert_float("success", e.message), e.proposal_warning && 0 != e.proposal_warning ? ($("body").find(
            "#lead_proposal_warning").removeClass("hide"), $("body").find("#lead-modal").animate({
            scrollTop: 0
...
function lead_mark_as_lost(e) {
    requestGetJSON("leads/mark_as_lost/" + e).done(function(t) {
        1 == t.success && (alert_float("success", t.message), $("body").find("tr#lead_" + e).remove(), $("body").find('#kan-ban li[data-lead-id="' + e +
            '"]').remove()), _lead_init_data(t, t.id)
    }).fail(function(e) {
        alert_float("danger", e.responseText)
    })
}
...
function leads_bulk_action(e) {
    if (confirm_delete()) {
        var t = $("#mass_delete").prop("checked"),
            ...
            i = {};
        if (0 == t || void 0 === t) {
            if (i.status = $("#move_to_status_leads_bulk").val(), i.assigned = $("#assign_to_leads_bulk").val(), i.source = $("#move_to_source_leads_bulk").val(),
                i.last_contact = $("#leads_bulk_last_contact").val(), i.tags = $("#tags_bulk").tagit("assignedTags"), i.visibility = $(
                    'input[name="leads_bulk_visibility"]:checked').val(), i.assigned = void 0 === i.assigned ? "" : i.assigned, i.visibility = void 0 === i.visibility ?
                "" : i.visibility, "" == i.status && "" == i.assigned && "" == i.source && "" == i.last_contact && "" == i.tags && "" == i.visibility) return
...
function sync_proposals_data(e, t) {
    ...
    a.country = i.find('select[name="country"]').val(), a.zip = i.find('input[name="zip"]').val(), a.state = i.find('input[name="state"]').val(), a.city = i.find(
            'input[name="city"]').val(), a.address = i.find('textarea[name="address"]').val(), a.phone = i.find('input[name="phone"]').val(), a.rel_id = e, a.rel_type =
        t, $.post(admin_url + "proposals/sync_data", a).done(function(e) {
...
function init_table_tickets(e) {	
    ...
    if (0 != $("body").find(".tickets-table").length) {
        ...
        var s = [t], 
			o = admin_url + "tickets";
        $("body").hasClass("tickets_page") && (s.push(0), o += "?bulk_actions=true"), _table_api = initDataTable(".tickets-table", o, s, s, a, [n, "DESC"])
    	
		// _table_api && $("body").hasClass("dashboard") && _table_api.column(t).visible(!1, !1).column(3).visible(!1, !1).column(n).visible(!1, !1).column(4)
		// .visible(!1, !1).column(5).visible(!1, !1).columns.adjust()
    }
}

//bilal code start
function init_table_tickets_so(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-ticket"))) return !1;
    if (0 != $("body").find(".tickets-table-so").length) {
        var t = $(".tickets-table-so").find("th").length - 1,
            a = {},
            i = $("._hidden_inputs._filters.tickets_filters input"),
            n = $("table.tickets-table-so thead .ticket_created_column").index();
        $.each(i, function() {
            a[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        }), a.saleopp_id = '[name="project_id"]';
        var s = [t],
            o = admin_url + "tickets";
        $("body").hasClass("tickets_page") && (s.push(0), o += "?bulk_actions=true"), 
		_table_api = initDataTable(".tickets-table-so", o, s, s, a, [n, "DESC"]),
            _table_api && $("body").hasClass("dashboard") && _table_api.column(t).visible(!1, !1).column(3).visible(!1, !1).column(n).visible(!1, !1).column(4)
            .visible(!1, !1).column(5).visible(!1, !1).columns.adjust()
    }
}
...
function init_table_staff_projects_so(e) {
    if (void 0 === e && $("body").hasClass("dashboard")) return !1;
    if (0 != $("body").find(".table-staff-saleopp").length) {
        var t = {},
            a = $("._hidden_inputs._filters.staff_saleopp_filter input");
        $.each(a, function() {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
		}), initDataTable(".table-staff-saleopp", admin_url + "sales/staff_sales", "undefined", "undefined", t, [2, "ASC"])
    }
}
...
function do_task_checklist_items_height(e) {
    void 0 === e && (e = $("body").find("textarea[name='checklist-description']")), $.each(e, function() {
        var e = $(this).val();
        $(this).outerHeight() < this.scrollHeight + parseFloat($(this).css("borderTopWidth")) + parseFloat($(this).css("borderBottomWidth")) && ($(this)
            .height(0).height(this.scrollHeight), $(this).parents(".checklist").height(this.scrollHeight)), "" == e && ($(this).removeAttr("style"),
...
function recalculate_checklist_items_progress() {
    var e = $('input[name="checklist-box"]:checked').length,
        ...
        a = 0,
        i = $(".task-progress-bar");
    if (0 == t ? ($("body").find(".chk-heading").remove(), $("#task-no-checklist-items").removeClass("hide")) : $("#task-no-checklist-items").addClass("hide"), !
        (t > 2)) return i.parents(".progress").addClass("hide"), !1;
...
function remove_checklist_item_template(e) {
    requestGetJSON("tasks/remove_checklist_item_template/" + e).done(function(t) {
        if (1 == t.success) {
            ...
            }), a.find('option[value="' + e + '"]').remove(), a.selectpicker("refresh"), 1 == a.find("option").length && (a.selectpicker("destroy"),
...
function save_checklist_item_template(e, t) {
    ...
    $.post(admin_url + "tasks/save_checklist_item_template", {
        ...
        i.find('select option[value=""]').after('<option value="' + e.id + '">' + a.trim() + "</option>"), i.removeClass("hide"), i.find("select").selectpicker(
            "refresh")
    })
}
...
function remove_task_attachment(e, t) {
    confirm_delete() && requestGetJSON("tasks/remove_task_attachment/" + t).done(function(e) {
        ...
        0 == i.length ? a.remove() : 2 == i.length && n.hasClass("hide") ? $("body").find("#show-more-less-task-attachments-col").remove() : 0 != $(
            ".task-attachment-col:visible").length || n.hasClass("hide") || n.click()
    })
}
...
function task_mark_as(e, t, a) {
    ...
    a += "?single_task=" + i, $("body").append('<div class="dt-loader"></div>'), requestGetJSON(a).done(function(a) {
        $("body").find(".dt-loader").remove(), 1 == a.success && (reload_tasks_tables(), i && _task_append_html(a.taskHtml), 5 == e && "function" ==
            typeof _maybe_remove_task_from_project_milestone && _maybe_remove_task_from_project_milestone(t), 0 == $(".tasks-kanban").length &&
...
function new_task_from_relation(e, t, a) {
    void 0 === t && void 0 === a && (a = $(e).data("new-rel-id"), t = $(e).data("new-rel-type")), new_task(admin_url + "tasks/task?rel_id=" + a + "&rel_type=" +
        t)

}

//bilal code start
function new_task_from_relation_so(e, t, a) {
    void 0 === t && void 0 === a && (a = $(e).data("new-rel-id"), t = $(e).data("new-rel-type")), new_task(admin_url + "tasks/task?rel_id=" + a + "&rel_type=" +
        t)
}
//bilal code end
...
function system_popup(e) {
    ...
    var t = $("<div/>", {
        ...
        a = "";
    return a += '<div class="popup-wrapper fadeIn animated">', a += '<h2 class="popup-message">', a += e.message, a += "</h2>", a +=
        '<div class="popup-content">', a += e.content, a += '<button type="button" class="system-popup-close"> </button>', a += "</div>", a += "</div>", t.html(
            a).removeClass("hide"), $("body").addClass("system-popup"), t.find(".system-popup-close").on("click", function() {
            var e = this;
...
function timer_action(e, t, a) {
    ...
    if ("" != t || !i.is(":visible")) {
        if ("" != a && "0" == t) {
            var n = {};
            return n.content = "", n.content += '<div class="row">', n.content += '<div class="form-group"><select id="timer_add_task_id" data-empty-title="' +
                appLang.search_tasks + '" data-width="60%" class="ajax-search" data-live-search="true">', n.content += "</select></div>", n.content +=
                '<div class="form-group">', n.content += '<textarea id="timesheet_note" placeholder="' + appLang.note +
                '" style="margin:0 auto;width:60%;" rows="4" class="form-control"></textarea>', n.content += "</div>", n.content +=
                "<button type='button' onclick='timer_action(this,document.getElementById(\"timer_add_task_id\").value," + a +
                ");return false;' class='btn btn-info'>" + appLang.confirm + "</button>", n.message = appLang.task_stop_timer, system_popup(n).attr("id",
                    "timer-select-task"), init_ajax_search("tasks", "#timer_add_task_id", void 0, admin_url + "tasks/ajax_search_assign_task_to_timer"), !1
        }
        $(e).addClass("disabled");
        var s = {};
        ...
        $.post(admin_url + "tasks/timer_tracking?single_task=" + o, s).done(function(e) {
            e = JSON.parse(e), o && _task_append_html(e.taskHtml), i.is(":visible") && i.find(".system-popup-close").click(), _init_timers_top_html(
                JSON.parse(e.timers)), $(".popover-top-timer-note").popover("hide"), reload_tasks_tables()
        })
    }
}
...
function init_task_modal(e) {
    var t = "",
        a = $("#lead-modal"),
        i = $("#_task_modal");
    a.is(":visible") ? (t += "?opened_from_lead_id=" + a.find('input[name="leadid"]').val(), a.modal("hide")) : void 0 != i.attr("data-lead-id") && (t +=
        "?opened_from_lead_id=" + i.attr("data-lead-id")), requestGet("tasks/get_task_data/" + e + t).done(function(e) {
        _task_append_html(e)
    }).fail(function(e) {
...
function edit_task_comment(e) {
    ...
    t.next().addClass("hide"), t.removeClass("hide"), tinymce.remove("#task_comment_" + e), init_editor("#task_comment_" + e, _simple_editor_config()), tinymce
        .triggerSave()
}
...
function _simple_editor_config() {
    return {
        ...
        toolbar: "insert formatselect bold forecolor backcolor" + (is_mobile() ? " | " : " ") +
...
function save_edited_comment(e, t) {
    tinymce.triggerSave();
    var a = {};
    a.id = e, a.task_id = t, a.content = $('[data-edit-comment="' + e + '"]').find("textarea").val(), $.post(admin_url + "tasks/edit_comment", a).done(function(
        t) {
        1 == (t = JSON.parse(t)).success ? (alert_float("success", t.message), _task_append_html(t.taskHtml)) : cancel_edit_comment(e), tinymce.remove(
            '[data-edit-comment="' + e + '"] textarea')
    })
}
...
function edit_task_inline_description(e, t) {
    tinyMCE.remove("#task_view_description"), $(e).hasClass("editor-initiated") ? $(e).removeClass("editor-initiated") : ($(e).addClass("editor-initiated"), $.Shortcuts
        .stop(), tinymce.init({
...
function tasks_bulk_action(e) {
    if (confirm_delete()) {
        ...
        if (0 == i || void 0 === i) {
            ...
            if (a.milestone = o.length ? o.selectpicker("val") : "", a.priority = $("#task_bulk_priority").val(), a.priority = void 0 === a.priority ? "" : a.priority,
                "" == a.status && "" == a.priority && "" == a.tags && "" == a.assignees && "" == a.milestone) return
...
function load_small_table_item(e, t, a, i, n) {
    ...
    "" == s || window.location.hash ? window.location.hash && !e && (e = window.location.hash.substring(1)) : (e = s, $('input[name="' + a + '"]').val("")),
        void 0 !== e && "" != e && ($("body").hasClass("small-table") || toggle_small_view(n, t), $('input[name="' + a + '"]').val(e), do_hash_helper(e), $(t).load(
            admin_url + i + "/" + e), is_mobile() && $("html, body").animate({
...
function clear_billing_and_shipping_details() {
    for (var e in bs_fields) bs_fields[e].indexOf("country") > -1 ? $('select[name="' + bs_fields[e] + '"]').selectpicker("val", "") : ($('input[name="' +
        bs_fields[e] + '"]').val(""), $('textarea[name="' + bs_fields[e] + '"]').val("")), "billing_country" == bs_fields[e] && ($(
        'input[name="include_shipping"]').prop("checked", !1), $('input[name="include_shipping"]').change());
...
function init_billing_and_shipping_details() {
    ...
    for (var a in bs_fields) e = "", e = bs_fields[a].indexOf("country") > -1 ? $("#" + bs_fields[a] + " option:selected").data("subtext") : bs_fields[a].indexOf(
            "shipping_street") > -1 || bs_fields[a].indexOf("billing_street") > -1 ? $('textarea[name="' + bs_fields[a] + '"]').val().replace(/(?:\r\n|\r|\n)/g,
            "<br />") : $('input[name="' + bs_fields[a] + '"]').val(), bs_fields[a].indexOf("shipping") > -1 && (t || (e = "")), void 0 === e && (e = ""), e =
        "" != e ? e : "--", $("." + bs_fields[a]).html(e);
...
function add_item_to_preview(e) {
    requestGetJSON("invoice_items/get_item_by_id/" + e).done(function(e) {
        clear_item_preview_values(), $('.main textarea[name="description"]').val(e.description), $('.main textarea[name="long_description"]').val(e.long_description
            .replace(/(<|&lt;)br\s*\/*(>|&gt;)/g, " ")), _set_item_preview_custom_fields_array(e.custom_fields), $('.main input[name="quantity"]').val(
            1);
        var t = [];
        e.taxname && e.taxrate && t.push(e.taxname + "|" + e.taxrate), e.taxname_2 && e.taxrate_2 && t.push(e.taxname_2 + "|" + e.taxrate_2), $(
            ".main select.tax").selectpicker("val", t), $('.main input[name="unit"]').val(e.unit);
...
function add_task_to_preview_as_item(e) {
    requestGetJSON("tasks/get_billable_task_data/" + e).done(function(t) {
        ...
        var a = $(".main");
        a.find('textarea[name="description"]').val(t.name), a.find('textarea[name="long_description"]').val(t.description), a.find(
            'input[name="quantity"]').val(t.total_hours), a.find('input[name="rate"]').val(t.hourly_rate), a.find('input[name="unit"]').val(""), $(
            'input[name="task_id"]').val(e), $(document).trigger({
            type: "item-added-to-preview",
            item: t,
            item_type: "task"
        })
...
function clear_item_preview_values(e) {
    var t = $("table.items tbody").find("tr:last-child").find("select").selectpicker("val"),
        a = $(".main");
    a.find("textarea").val(""), a.find('td.custom_field input[type="checkbox"]').prop("checked", !1), a.find(
        "td.custom_field input:not(:checkbox):not(:hidden)").val(""), a.find("td.custom_field select").selectpicker("val", ""), a.find(
        'input[name="quantity"]').val(1), a.find("select.tax").selectpicker("val", t), a.find('input[name="rate"]').val(""), a.find('input[name="unit"]').val(
...
function add_item_to_table(e, t, a, i) {
    if ("" !== (e = void 0 === e || "undefined" == e ? get_item_preview_values() : e).description || "" !== e.long_description || "" !== e.rate) {
        ...
        n += '<tr class="sortable item" data-merge-invoice="' + a + '" data-bill-expense="' + i + '">', n += '<td class="dragger">', isNaN(e.qty) && (e.qty = 1),
        ...
        return get_taxes_dropdown_template(d, e.taxname).done(function(a) {
            n += '<input type="hidden" class="order" name="newitems[' + o + '][order]">', n += "</td>", n +=
                '<td class="bold description"><textarea name="newitems[' + o + '][description]" class="form-control" rows="5">' + e.description +
                "</textarea></td>", n += '<td><textarea name="newitems[' + o +
                '][long_description]" class="form-control item_long_description" rows="5">' + e.long_description.replace(r, "\n") + "</textarea></td>";
            ...
            i.length > 0 && $.each(i, function() {
                    ...
                    if (a.is(":checkbox")) {
                        ...
                        $.each(l, function(e, t) {
                            ...
                            $(this).attr("id", a).attr("name", i).next("label").attr("for", a), "1" == $(this).attr(
                                "data-custom-field-required") && (d = !0)
                        }), $.each(s, function(t, a) {
                            e.find('input[value="' + $(a).val() + '"]').attr("checked", !0)
                        }), t = e.html()
                    } else if (a.is("input") || a.is("textarea")) a.is("input") ? e.find("[data-fieldid]").attr("value", a.val()) : e.find(
                        "[data-fieldid]").html(a.val()), e.find("[data-fieldid]").attr("name", i), "1" == e.find("[data-fieldid]").attr(
                        "data-custom-field-required") && (d = !0), t = e.html();
                    else if (a.is("select")) {
                ...
                }), n += '<td><input type="number" min="0" onblur="calculate_total();" onchange="calculate_total();" data-quantity name="newitems[' + o +
                '][qty]" value="' + e.qty + '" class="form-control">', s = "", e.unit && void 0 !== e.unit || (s = appLang.unit, e.unit = ""), n +=
                '<input type="text" placeholder="' + s + '" name="newitems[' + o + '][unit]" class="form-control input-transparent text-right" value="' +
                e.unit + '">', n += "</td>", n += '<td class="rate"><input type="number" data-toggle="tooltip" title="' + appLang.item_field_not_formatted +
                '" onblur="calculate_total();" onchange="calculate_total();" name="newitems[' + o + '][rate]" value="' + e.rate +
                '" class="form-control"></td>', n += '<td class="taxrate">' + a + "</td>", n += '<td class="amount" align="right">' + l + "</td>", n +=
                '<td><a href="#" class="btn btn-danger pull-left" onclick="delete_item(this,' + t +
                '); return false;"><i class="fa fa-trash"></i></a></td>', n += "</tr>", $("table.items tbody").append(n), $(document).trigger({
            ...
            })), init_selectpicker(), init_datepicker(), init_color_pickers(), clear_item_preview_values(), reorder_items(), $("body").find(
                "#items-warning").remove(), $("body").find(".dt-loader").remove(), $("#item_select").selectpicker("val", ""), 1 == d && $(
                ".invoice-form").length ? validate_invoice_form() : d && $(".estimate-form").length ? validate_estimate_form() : d && $(
                ".proposal-form").length ? validate_proposal_form() : d && $(".credit-note-form").length && validate_credit_note_form(), !0
        }), !1
    }
}
...
function deselect_ajax_search(e) {
    ...
    t.html("").append('<option value=""></option>').selectpicker("val", ""), a.removeClass("ajax-remove-values-option").find(".ajax-clear-values").remove(),
        setTimeout(function() {
...
function get_item_preview_values() {
    var e = {};
    return e.description = $('.main textarea[name="description"]').val(), e.long_description = $('.main textarea[name="long_description"]').val(), e.qty = $(
            '.main input[name="quantity"]').val(), e.taxname = $(".main select.tax").selectpicker("val"), e.rate = $('.main input[name="rate"]').val(), e.unit =
        $('.main input[name="unit"]').val(), e
}
...
function calculate_total() {
    ...
    $(".tax-area").remove(), $.each(_, function() {
            "" == (r = $(this).find("[data-quantity]").val()) && (r = 1, $(this).find("[data-quantity]").val(1)), n = accounting.toFixed($(this).find(
                    "td.rate input").val() * r, app_decimal_places), n = parseFloat(n), $(this).find("td.amount").html(accounting.formatNumber(n)), l += n,
                i = $(this), (a = $(this).find("select.tax").selectpicker("val")) && $.each(a, function(a, l) {
                    t = i.find('select.tax [value="' + l + '"]').data("taxrate"), e = n / 100 * t, o.hasOwnProperty(l) ? o[l] = o[l] += e : 0 != t && (
                        s = l.split("|"), tax_row = '<tr class="tax-area"><td>' + s[0] + "(" + t + '%)</td><td id="tax_id_' + slugify(l) +
                        '"></td></tr>', $(p).after(tax_row), o[l] = e)
                })
        }), "" != u && 0 != u && "before_tax" == v && h.hasClass("discount-type-percent") ? c = l * u / 100 : "" != f && 0 != f && "before_tax" == v && h.hasClass(
            "discount-type-fixed") && (c = f), $.each(o, function(e, t) {
            "" != u && 0 != u && "before_tax" == v && h.hasClass("discount-type-percent") ? (total_tax_calculated = t * u / 100, t -= total_tax_calculated) :
                "" != f && 0 != f && "before_tax" == v && h.hasClass("discount-type-fixed") && (t -= t * (f / l * 100) / 100), d += t, t = accounting.formatNumber(
                    t), $("#tax_id_" + slugify(e)).html(t)
        }), d += l, "" != u && 0 != u && "after_tax" == v && h.hasClass("discount-type-percent") ? c = d * u / 100 : "" != f && 0 != f && "after_tax" == v && h
        .hasClass("discount-type-fixed") && (c = f), d -= c, m = parseFloat(m), isNaN(m) || (d += m);
    var b = "-" + accounting.formatNumber(c);
    $('input[name="discount_total"]').val(accounting.toFixed(c, app_decimal_places)), $(".discount-total").html(b), $(".adjustment").html(accounting.formatNumber(
        m)), $(".subtotal").html(accounting.formatNumber(l) + hidden_input("subtotal", accounting.toFixed(l, app_decimal_places))), $(".total").html(
        format_money(d) + hidden_input("total", accounting.toFixed(d, app_decimal_places))), $(document).trigger("sales-total-calculated")
}
...
function delete_proposal_attachment(e) {
    confirm_delete() && requestGet("proposals/delete_attachment/" + e).done(function(t) {
        if (1 == t) {
            var a = $("body").find('input[name="_attachment_sale_id"]').val();
            $("body").find('[data-attachment-id="' + e + '"]').remove(), $("body").hasClass("proposals-pipeline") ? proposal_pipeline_open(a) :
                init_proposal(a)
        }
    }).fail(function(e) {
        alert_float("danger", e.responseText)
...
function do_prefix_year(e) {
    var t;
    e.indexOf(".") > -1 ? t = e.split(".") : e.indexOf("-") > -1 ? t = e.split("-") : e.indexOf("/") > -1 && (t = e.split("/")), void 0 !== t && $.each(t,
        function(e, a) {
            if (4 == a.length) {
                var i = $("#prefix_year");
                if (i.hasClass("format-n-yy")) a = a.substr(-2);
                    ...
                    var n;
                    "d-m-Y" == app_date_format || "d/m/Y" == app_date_format || "Y-m-d" == app_date_format || "d.m.Y" == app_date_format ? n = 1 : "m-d-Y" !=
                        app_date_format && "m.d.Y" != app_date_format && "m/d/Y" != app_date_format || (n = 0), $("#prefix_month").html(t[n])
                }
                i.html(a)
            }
        })
            ...
            i.length > 0 && $.each(i, function(e, a) {
                ...
                $.notify("", {
                    ...
                    requestGet("misc/set_desktop_notification_read/" + a).done(function(e) {
                        ...
                        var n = i.text();
                        n = n.trim(), (n -= 1) > 0 ? (document.title = "(" + n + ") " + doc_initial_title, i.html(n)) :
                            (document.title = doc_initial_title, i.addClass("hide"))
                    })
                }).click(function(e) {
	...
	if (n.length) {
        var s = {
            ...
            preprocessData: function(e) {
				 setTimeout(function(){
					var i = 1;
					New_contact_bt = $('#contactid').parent().find('ul');
					console.log($(New_contact_bt).find('li').length);
					$(New_contact_bt).find('li').each(function(){
						
						if(i == $(New_contact_bt).find('li').length)
						{
							//val = e[i].link.split("?");
							//clientid = val[0].split('/').pop();	
							$(this).append('<span onclick="contact(); return false;" style="width:25%; color:white; margin-left: 17px;" class="btn btn-info new-contact">New Contact</span>');
						}
						i++;
					});
				},500);
				...
				console.log(t);
				//t.push($('li').append("<button>hello</buttton>"));
				return t
...
$(document).on('show.bs.modal','#contact', function () {
	if($('body').find('.company_opt_appended__').length >  0)
	{
	}
	else
	{
...
$(window).on("load", function() {
    ...
    }), $.fn.dataTable.ext.errMode = "throw", $.fn.dataTableExt.oStdClasses.sWrapper = "dataTables_wrapper form-inline dt-bootstrap table-loading", Dropzone.options
    .newsFeedDropzone = !1, Dropzone.options.salesUpload = !1, "Notification" in window && "1" == app_desktop_notifications && Notification.requestPermission(),
    $.validator.setDefaults({
        highlight: function(e) {
            var t = $(e).parents(".tab-pane");
            t.length && !t.is(":visible") && $('a[href="#' + t.attr("id") + '"]').css("border-bottom", "1px solid red").css("color", "red").addClass(
                "tab-validation"), $(e).closest(".form-group").addClass("has-error")
        },
        unhighlight: function(e) {
            var t = $(e).parents(".tab-pane");
            t.length && $('a[href="#' + t.attr("id") + '"]').removeAttr("style").removeClass("tab-validation"), $(e).closest(".form-group").removeClass(
                "has-error")
        },
        errorElement: "p",
        errorClass: "text-danger",
        errorPlacement: function(e, t) {
            t.parent(".input-group").length || t.parents(".chk").length ? t.parents(".chk").length ? e.insertAfter(t.parents(".chk")) : e.insertAfter(t
                .parent()) : e.insertAfter(t)
        }
        ...
        if ($(this).selectpicker("val")) {
            ...
            0 === t.find(".ajax-clear-values").length && t.addClass("ajax-remove-values-option").find("button.dropdown-toggle").after(
                '<span class="pointer ajax-clear-values" onclick="deselect_ajax_search(this); return false;" data-id="' + $(this).attr("id") +
                '"><i class="fa fa-remove"></i></span>')
        }
    }), $("body").on("rendered.bs.select", "select", function() {
        $(this).parents().removeClass("select-placeholder")
    });
var original_top_search_val, table_leads, table_activity_log, table_estimates, table_invoices , table_invoices_so, table_tasks, tab_active = get_url_param("tab"),
...
$(window).on("load resize", function(e) {
    ...
    total_unread_notifications > 0 && (document.title = "(" + total_unread_notifications + ") " + doc_initial_title), $(".screen-options-btn").on(
        "click",
        function() {
        ...
        var e = $("#lead-modal"),
            t = $("#task-modal");
        e.is(":visible") || t.is(":visible") ? e.is(":visible") ? $("a[lead-edit]").click() : t.is(":visible") && edit_task(t.find(
            "[data-task-single-id]").attr("data-task-single-id")) : window.location.href = admin_url + "estimates/estimate"
        ...
        e.length > 0 ? new_task(admin_url + "tasks/task?rel_id=" + e.attr("data-rel-id") + "&rel_type=" + e.attr("data-rel-type")) : $("body").hasClass(
            "project") ? new_task(admin_url + "tasks/task?rel_id=" + project_id + "&rel_type=project") : new_task()
    ...
    tab_active && e.find('[href="#' + tab_active + '"]').click(), tab_group && (e.find("li").not('[role="presentation"]').removeClass("active"), e.find(
            '[data-group="' + tab_group + '"]').parents("li").addClass("active")), moment.locale(locale), moment().tz(app_timezone).format(), jQuery.datetimepicker
        .setLocale(locale), init_editor(), $("body").on("click", "#started-timers-top,.popover-top-timer-note", function(e) {
            e.stopPropagation()
        ...
        }), custom_fields_hyperlink(), init_lightbox(), init_progress_bars(), init_datepicker(), $("body").on("loaded.bs.select",
            "._select_input_group",
            function(e) {
    ...
    if ($.each(t, function(e, t) {
            ...
            if (location == a) {
                ...
                i.parents("li").not(".quick-links").addClass("active"), i.prop("aria-expanded", !0), i.parents("ul.nav-second-level").prop(
                    "aria-expanded", !0), i.parents("li").find("a:first-child").prop("aria-expanded", !0)
            }
        ...
        $.each(a, function(e, t) {
            ...
            if (location == a) {
                ...
                i.parents("li").addClass("active"), i.prev("active"), i.parents("ul.nav-second-level").prop("aria-expanded", !0), i.parents(
                    "li").find("a:first-child").prop("aria-expanded", !0)
            }
        })
    }
    if (side_bar.metisMenu(), setup_menu.metisMenu(), $(".hide-menu").click(function(e) {
            e.preventDefault(), $(window).width() < 769 ? $("body").toggleClass("show-sidebar") : $("body").toggleClass("hide-sidebar"), setup_menu
                .hasClass("display-block") && $(".close-customizer").click()
        }), is_mobile() && content_wrapper.on("click", function() {
            $("body").hasClass("show-sidebar") && $("body").removeClass("show-sidebar"), setup_menu.hasClass("display-block") && $(
            ...
            if ("" === e) return content_wrapper.unhighlight(), t.html(""), original_top_search_val = "", void a.html(
                '<i class="fa fa-search"></i>').removeClass("search_remove");
            e.length < 2 && -1 === app_language.indexOf("chinese") && -1 === app_language.indexOf("japanese") || (a.html(
                '<i class="fa fa-remove"></i>').addClass("search_remove"), delay(function() {
            ...
            if ((a = a.replace(t, "")).indexOf(":") > -1) {
                ...
                1 == i[0].toString().length && (i[0] = "0" + i[0]), 1 == i[1].toString().length ? i[1] = "0" + i[1] : 0 == i[1].toString().length &&
                    (i[1] = "00"), a = i[0] + ":" + i[1]
            ...
            $(this).find("span").not(t).removeClass("hide").addClass("switch-to"), $(".timesheet-start-end-time,.timesheet-duration").toggleClass(
                "hide"), $(".timesheet-start-end-time input").val(""), $(".timesheet-duration input").val("")
        }), $("body").on("hidden.bs.modal", ".modal-reminder", function(e) {
            var t = $(this),
                a = t.find('input[name="rel_id"]').val(),
                i = t.find('input[name="rel_type"]').val();
            t.find("form").attr("action", admin_url + "misc/add_reminder/" + a + "/" + i), t.find(":input:not([type=hidden]), textarea").val(""), t
                .find('input[type="checkbox"]').prop("checked", !1), t.find("select").selectpicker("val", "")
            ...
            $.post(admin_url + "tasks/update_checklist_item", {
                ...
                !0 === (i = JSON.parse(i)).can_be_template && e.parents(".checklist").find(".save-checklist-template").removeClass("hide"),
                    "" === t && $("#checklist-items").find('.checklist[data-checklist-id="' + a + '"]').remove()
            })
            ...
            "1" == has_permission_tasks_checklist_items_delete && setTimeout(function() {
                ...
                $.each(t, function(t, a) {
                    var i = $(a);
                    0 == $(e[t]).find(".checklist-item-template-remove").length && $(e[t]).find("a > span.text").after(
                        '<small class="checklist-item-template-remove" onclick="remove_checklist_item_template(' + i.attr(
                            "value") + '); event.stopPropagation();"><i class="fa fa-remove"></i></small>')
                })
            }, 100)
        }), $("body").on("change", "select.custom-field-multi-select", function() {
            var e = $(this).selectpicker("val");
            0 == e.length || 1 == e.length && "" == e[0] ? $(this).selectpicker("val", "") : e.length > 1 && "" == e[0] && (e.splice(0, 1), $(this)
                .selectpicker("val", e))
            ...
            $.each(e, function() {
                ...
                "startdate" == e && "" == a ? i.addClass("text-danger") : "startdate" == e && "" != a && i.removeClass("text-danger"), (
                    "startdate" == e && "" != a || "startdate" != e) && (t[$(this).attr("name")] = a, "startdate" != e && "" == a ? i.css(
                    "opacity", .5) : i.css("opacity", 1))
            });
            ...
            var e = $(this).val();
            add_task_checklist_item($("#task-modal").find("[data-task-single-id]").attr("data-task-single-id"), $(this).find('option[value="' + e +
                '"]').html().trim()), $(this).selectpicker("val", "")
            ...
            view_chk_selector = $(this).parents("tr").find("td input[" + (void 0 !== e && !1 !== e ? "data-can-view" : "data-can-view-own") + "]"),
                view_chk_selector.prop("checked", !1), !0 === $(this).prop("checked") ? view_chk_selector.prop("disabled", !0) : view_chk_selector.prop(
                    "disabled", !1)
        }), "undefined" != typeof taskid && "" !== taskid && init_task_modal(taskid), $("body").on("change", 'input[name="checklist-box"]', function() {
            requestGet(admin_url + "tasks/checkbox_action/" + $(this).parents(".checklist").data("checklist-id") + "/" + (!0 === $(this).prop(
                "checked") ? 1 : 0)), recalculate_checklist_items_progress()
            ...
            if ("" != t && "" != a || "" != i) {
                var n = {};
                n.timesheet_duration = i, n.start_time = t, n.end_time = a, n.timesheet_task_id = $(this).data("task-id"), n.note = $("body").find(
                    "#task_single_timesheet_note").val(), n.timesheet_staff_id = $("body").find(
                    '#task-modal select[name="single_timesheet_staff_id"]').val(), $.post(admin_url + "tasks/log_time", n).done(function(e) {
                    1 == (e = JSON.parse(e)).success ? (init_task_modal(n.timesheet_task_id), alert_float("success", e.message), setTimeout(
                        function() {
                            reload_tasks_tables()
            ...
            var e = {};
            return e.copy_from = $(this).data("task-copy-from"), e.copy_task_assignees = $("body").find("#copy_task_assignees").prop("checked"), e.copy_task_followers =
                $("body").find("#copy_task_followers").prop("checked"), e.copy_task_checklist_items = $("body").find("#copy_task_checklist_items").prop(
                    "checked"), e.copy_task_attachments = $("body").find("#copy_task_attachments").prop("checked"), e.copy_task_status = $("body").find(
                    'input[name="copy_task_status"]:checked').val(), $.post(admin_url + "tasks/copy", e).done(function(e) {
            ...
            new_task(admin_url + "tasks/task?rel_type=project&rel_id=" + project_id + "&milestone_id=" + t), $('body [data-toggle="popover"]').popover(
                "hide")
            ...
            tinyMCE.remove(".tinymce-task"), "undefined" != typeof _ticket_message && (_ticket_message = void 0), void 0 == $(this).attr(
                "data-lead-id") || $(this).attr("data-task-created") || init_lead($(this).attr("data-lead-id")), $(
                "body #_task_modal .datepicker").datetimepicker("destroy"), $("#_task").empty()
            ...
            $("body").append('<div class="dt-loader"></div>');
            var e = {};
            e.assignee = $('select[name="select-assignees"]').val(), "" != e.assignee && (e.taskid = $(this).attr("data-task-id"), $.post(admin_url +
                "tasks/add_task_assignees", e).done(function(e) {
            ...
            var e = {};
            e.follower = $('select[name="select-followers"]').val(), "" != e.follower && (e.taskid = $(this).attr("data-task-id"), $("body").append(
                '<div class="dt-loader"></div>'), $.post(admin_url + "tasks/add_task_followers", e).done(function(e) {
            ...
            "lead" == $("#sync_data_proposal_data").data("rel-type") && $("#lead-modal .data").eq(0).css("height", $(
                "#sync_data_proposal_data .modal-content").height() + 80 + "px").css("overflow-x", "hidden")
            ...
            2 == e ? $("#merge_db_field_" + t).removeClass("hide") : $("#merge_db_field_" + t).addClass("hide"), 3 == e ? $(
                "#merge_db_contact_field_" + t) : $("#merge_db_contact_field_" + t).addClass("hide")
        ...
        var i = {
            ...
            loading: function(e, t) {
                e && $("#calendar .fc-header-toolbar .btn-default").addClass("btn-info").removeClass("btn-default").css("display", "block"), e ?
                    $(".dt-loader").removeClass("hide") : $(".dt-loader").addClass("hide")
            },
            eventSources: [{
        ...
        if ($("body").hasClass("dashboard") && (i.customButtons.viewFullCalendar = {
            ...
            }, 1 == is_staff_member && ("" != google_api && (i.googleCalendarApiKey = google_api), "" != calendarIDs && (calendarIDs = JSON.parse(
                calendarIDs), 0 != calendarIDs.length)))
            if ("" != google_api)
                for (var n = 0; n < calendarIDs.length; n++) {
                    var s = {};
                    s.googleCalendarId = calendarIDs[n], i.eventSources.push(s)
                } else console.error(
                    "You have setup Google Calendar IDs but you dont have specified Google API key. To setup Google API key navigate to Setup->Settings->Misc"
                );
        calendar_selector.fullCalendar(i), get_url_param("new_event") && ($("input[name='start'].datetimepicker").val(get_url_param("date")), $(
            "#newEventModal").modal("show"))
    }
    $("body").on("change", 'select[name="tax"]', function() {
        var e = $("body").find('select[name="tax2"]'),
            t = $(this);
        "" != t.val() ? e.prop("disabled", !1) : (e.prop("disabled", !0), "" != e.val() && (t.val(e.val()), e.val(""), t.selectpicker("refresh"))),
        ...
        }), e.find("#credits-alert").remove(), e.find(".amount-to-credit").html(accounting.formatNumber(a)), i < a ? ($(".credits-table").before(
            $("<div/>", {
                id: "credits-alert",
                class: "alert alert-danger"
            }).html(appLang.credit_amount_bigger_then_credit_note_remaining_credits)), e.find('[type="submit"]').prop("disabled", !0)) : (e
            .find(".credit-note-balance-due").html(accounting.formatNumber(i - a)), e.find('[type="submit"]').prop("disabled", !1))
        ...
        }), e.find("#credits-alert").remove(), e.find(".amount-to-credit").html(accounting.formatNumber(a)), a > i ? ($(".credits-table").before(
            $("<div/>", {
                id: "credits-alert",
                class: "alert alert-danger"
            }).html(appLang.credit_amount_bigger_then_invoice_balance)), e.find('[type="submit"]').prop("disabled", !0)) : (e.find(
            ".invoice-balance-due").html(accounting.formatNumber(i - a)), e.find('[type="submit"]').prop("disabled", !1))
    }), $('input[name="notify_type"]').on("change", function() {
        var e = $('input[name="notify_type"]:checked').val(),
            t = $("#specific_staff_notify"),
            a = $("#role_notify");
        "specific_staff" == e ? (t.removeClass("hide"), a.addClass("hide")) : "roles" == e ? (t.addClass("hide"), a.removeClass("hide")) :
            "assigned" == e && (t.addClass("hide"), a.addClass("hide"))
    }), $("body").on("shown.bs.modal", "#lead-modal", function(e) {
        custom_fields_hyperlink(), 0 == $("body").find('#lead-modal input[name="leadid"]').length && $("body").find(
            '#lead-modal input[name="name"]').focus()
    }), $("#lead-modal").on("hidden.bs.modal", function(e) {
        $(this).data("bs.modal", null), $("#lead_reminder_modal").html(""), $("#lead-modal").is(":visible") || history.pushState("", document.title,
                window.location.pathname + window.location.search), $("body #lead-modal .datetimepicker").datetimepicker("destroy"),
    ...
    $("body").on("click", ".add_more_attachments", function() {
        ...
        t.find("input").removeAttr("aria-describedby aria-invalid"), t.find(".has-error").removeClass("has-error"), t.find("input").attr("name",
                "attachments[" + o + "]").val(""), t.find('p[id*="error"]').remove(), t.find("i").removeClass("fa-plus").addClass("fa-minus"),
        ...
        "#tab_lead_profile" == this.hash || "#attachments" == this.hash || "#lead_notes" == this.hash || "#lead_activity" == this.hash ? window
            .location.hash = this.hash : history.pushState("", document.title, window.location.pathname + window.location.search), $(document).resize()
    ...
    if ((table_leads = $("table.table-leads")).length) {
        ...
        initDataTable(table_leads, admin_url + "leads/table", [d.length - 1, 0], [d.length - 1, 0], l, [table_leads.find("th.date-created").index(),
            "DESC"
        ]), $.each(l, function(e, t) {
            $("select" + t).on("change", function() {
                console.log($(this).val());
                "lost" == $(this).val() || "junk" == $(this).val() ? $("[name='view_status[]']").prop("disabled", !0).selectpicker(
                        "refresh") : $("[name='view_status[]']").prop("disabled", !1).selectpicker("refresh"), table_leads.DataTable().ajax
                    .reload().columns.adjust().responsive.recalc()
            })
        })
    }
    
// Data Inventory customers st
 
    var l = {
            customer: "[name='customers[]']",
            statuses: "[name='statuses[]']"
    };
    if ((table_inventory = $("table.table-sale-inventory-items")).length) {
        var d = table_inventory.find("th");
        initDataTable(table_inventory, admin_url + "inventory/table", [d.length - 1, 0], [d.length - 1, 0], l), $.each(l, function(e, t) {
            $("select" + t).on("change", function() {
                console.log($(this).val());
                "lost" == $(this).val() || "junk" == $(this).val() ? $("[name='customers[]']").prop("disabled", !0).selectpicker(
                        "refresh") : $("[name='customers[]']").prop("disabled", !1).selectpicker("refresh"), table_inventory.DataTable().ajax
                    .reload().columns.adjust().responsive.recalc()
            })
        })
    }
// Data Inventory customers end
    ...
    if ($("body").on("change", 'input[name="contacted_today"]', function() {
        ...
        }), $("form").not("#single-ticket-form,#calendar-event-form,#proposal-form").areYouSure(), $("body").on("click", ".editor-add-content-notice",
            function() {
                $(this).remove(), tinymce.triggerSave()
            }), $(".bulk_actions").on("change", 'input[name="mass_delete"]', function() {
            var e = $("#bulk_change");
            1 == $(this).prop("checked") && e.find("select").selectpicker("val", ""), e.toggleClass("hide"), $(".mass_delete_separator").toggleClass(
                "hide")
        }), $("body").on("hidden.bs.modal", "#__todo", function() {
            var e = $("#__todo");
            e.find('input[name="todoid"]').val(""), e.find('textarea[name="description"]').val(""), e.find(".add-title").addClass("hide"), e.find(
                ".edit-title").addClass("hide")
        }), $("body").on("shown.bs.modal", "#__todo", function() {
            var e = $("#__todo");
            e.find('textarea[name="description"]').focus(), "" != e.find('input[name="todoid"]').val() ? (e.find(".add-title").addClass("hide"), e.find(
                ".edit-title").removeClass("hide")) : (e.find(".add-title").removeClass("hide"), e.find(".edit-title").addClass("hide"))
        }), $("#top_search_button button").on("click", function() {
            var e = $("#search_input");
            e.focus(), $(this).hasClass("search_remove") && ($(this).html('<i class="fa fa-search"></i>').removeClass("search_remove"),
                original_top_search_val = "", $("#search_results").html(""), e.val(""))
            ...
            $('[data-toggle="popover"],.manual-popover').each(function() {
                $(this).is(e.target) || 0 !== $(this).has(e.target).length || 0 !== $(".popover").has(e.target).length || $(this).popover(
                    "hide")
            })
            ...
            var e = $(this).val();
            "custom" == e ? $(".recurring_custom").removeClass("hide") : $(".recurring_custom").addClass("hide"), "" != e && 0 != e ? $("body").find(
                "#recurring_ends_on").removeClass("hide") : ($("body").find("#recurring_ends_on").addClass("hide"), $("body").find(
                "#recurring_ends_on input").val(""))
            ...
            e.preventDefault(), setup_menu.hasClass("true" == isRTL ? "fadeOutRight" : "fadeOutLeft") && setup_menu.removeClass("true" == isRTL ?
                    "fadeOutRight" : "fadeOutLeft"), setup_menu.addClass("display-block " + ("true" == isRTL ? "fadeInRight" : "fadeInLeft")),
                is_mobile() || requestGet("misc/set_setup_menu_open"), mainWrapperHeightFix()
        }), $("body").on("click", ".cpicker", function() {
            var e = $(this).data("color");
            if ($(this).hasClass("cpicker-big")) return !1;
            $(this).parents(".cpicker-wrapper").find(".cpicker-big").removeClass("cpicker-big").addClass("cpicker-small"), $(this).removeClass(
                "cpicker-small", "fast").addClass("cpicker-big", "fast"), $(this).hasClass("kanban-cpicker") ? ($(this).parents(
                ".panel-heading-bg").css("background", e), $(this).parents(".panel-heading-bg").css("border", "1px solid " + e)) : $(this).hasClass(
                "calendar-cpicker") && $("body").find('._event input[name="color"]').val(e)
            ...
            var n = !0;
            (t = t.split("#"))[1] && t[1].indexOf("=") > -1 && (n = !1, a = t[1].split("=")[1], t[1].indexOf("postid") > -1 ? (postid = a, $(
                        ".open_newsfeed").click()) : t[1].indexOf("taskid") > -1 ? init_task_modal(a) : t[1].indexOf("leadid") > -1 ? init_lead(a) :
                    t[1].indexOf("eventid") > -1 && view_event(a)), i.hasClass("desktopClick") || i.parent("li").find(".not-mark-as-read-inline").click(),
                n && setTimeout(function() {
                    window.location.href = t
                }, 50)
        }), $(".notifications-wrapper").on("show.bs.dropdown", function() {
            notifications_wrapper.find(".notifications").attr("data-total-unread") > 0 && $.post(admin_url + "misc/set_notifications_read").done(
                function(e) {
                    1 == (e = JSON.parse(e)).success && (document.title = doc_initial_title, $(".icon-notifications").addClass("hide"))
                })
        }), init_table_tickets() , init_table_tickets_so() , init_table_announcements(), init_table_staff_projects() , init_table_staff_projects_so(), (table_activity_log = $("table.table-activity-log")).length) {
        var r = [];
        r.activity_log_date = '[name="activity_log_date"]', initDataTable(table_activity_log, window.location.href, "undefined", "undefined", r, [1,
            "DESC"
        ])
    }
    if (table_invoices = $("table.table-invoices"), table_estimates = $("table.table-estimates"), table_invoices_so = $("table.table-invoices-so"), table_invoices.length > 0 || table_estimates.length > 0 || table_invoices_so.length > 0) {
        var c = {},
        ...
        $.each(_, function() {
            ...
            [3, "DESC"],
            [0, "DESC"]
        ]), table_invoices_so.length && initDataTable(table_invoices_so, admin_url + "invoices/table_so", "undefined", "undefined", c, [
            [3, "DESC"],
            [0, "DESC"]
        ])
    }
    if ((table_tasks = $(".table-tasks")).length) {
        ...
        $("body").hasClass("tasks_page") && (u.push(0), f += "?bulk_actions=true"), _table_api = initDataTable(table_tasks, f, u, u, m, [table_tasks.find(
            "th.duedate").index(), "ASC"]), _table_api && $("body").hasClass("dashboard") && _table_api.column(3).visible(!1, !1).column(4).visible(!
            1, !1).column(table_tasks.find(".table-tasks-options").index()).visible(!1, !1).columns.adjust()
    }
    $("#send_file").on("show.bs.modal", function(e) {
        var t = $("#send_file");
        t.find('input[name="filetype"]').val($($(e.relatedTarget)).data("filetype")), t.find('input[name="file_path"]').val($($(e.relatedTarget))
                .data("path")), t.find('input[name="file_name"]').val($($(e.relatedTarget)).data("file-name")), $('input[name="email"]').length >
            0 && t.find('input[name="send_file_email"]').val($('input[name="email"]').val())
    ...
    h.length > 0 && (h = h.sortable({
        ...
        }) : !0 === $(this).data("close") && (newsFeedDropzone.destroy(), $("#newsfeed").html(""), newsfeed_posts_page = 0,
            track_load_post_likes = 0, track_load_comment_likes = 0, postid = void 0), $("#newsfeed").toggleClass("hide"), $("body").toggleClass(
            "noscroll")
        ...
        var t = $(e.relatedTarget),
            a = $(t).data("commentid");
        comment_likes_total_pages = $(t).data("total-pages"), $(".load_more_post_comment_likes").attr("data-commentid", a), load_comment_likes(
            a)
    ...
    }), init_invoices_total(), init_expenses_total(), init_estimates_total(), init_items_sortable(), $(".settings-textarea-merge-field").on("click",
        function(e) {
            e.preventDefault();
            var t = $(this).text().trim(),
                a = $('textarea[name="settings[' + $(this).data("to") + ']"]');
            a.val(a.val() + "\n" + t)
        }), $("body").hasClass("estimates-pipeline") && estimate_pipeline_open($('input[name="estimateid"]').val()), $("body").hasClass(
        "proposals-pipeline") && proposal_pipeline_open($('input[name="proposalid"]').val()), $("body").on("submit", "._transaction_form", function() {
        calculate_total(), $("body").find("#items-warning").remove();
        var e = $(this).find("table.items"),
            t = e.find(".main");
        return t.find('[name="description"]').val().trim().length > 0 && t.find('[name="rate"]').val().trim().length > 0 ? (e.before(
            '<div class="alert alert-warning mbot20" id="items-warning">' + appLang.item_forgotten_in_preview + "</div>"), $(
            "html,body").animate({
            scrollTop: $("#items-warning").offset().top
        }), !1) : 0 == e.find(".item").length ? (e.before('<div class="alert alert-warning mbot20" id="items-warning">' + appLang.no_items_warning +
            "</div>"), $("html,body").animate({
            scrollTop: $("#items-warning").offset().top
        }), !1) : (reorder_items(), $('select[name="currency"]').prop("disabled", !1), $('select[name="project_id"]').prop("disabled", !1),
            $('input[name="date"]').prop("disabled", !1), $(this).find(".transaction-submit").prop("disabled", !0), !0)
    }), $("body").on("click", ".transaction-submit", function() {
        var e = $(this),
            t = e.parents("form._transaction_form");
        t.valid() && (e.hasClass("save-as-draft") ? t.append(hidden_input("save_as_draft", "true")) : e.hasClass("save-and-send") && t.append(
            hidden_input("save_and_send", "true"))), t.submit()
        ...
        if ("" != e.find('textarea[name="description"]').val()) return $.post(e.attr("action"), $(e).serialize()).done(function(t) {
            e.find('textarea[name="description"]').val(""), e.hasClass("estimate-notes-form") ? get_sales_notes(t, "estimates") : e
                .hasClass("invoice-notes-form") && get_sales_notes(t, "invoices")
        }), !1
        ...
        if (do_prefix_year(e), !($('input[name="isedit"]').length > 0)) {
            ...
            $("body").find("div.estimate").length > 0 && (a = admin_url + "estimates/get_due_date", t = "expirydate"), "" == e && $(
                'input[name="' + t + '"]').val(""), "" != e && $.post(a, {
                date: e
            }).done(function(e) {
    ...
    }), "undefined" != typeof Dropbox && $("#dropbox-chooser-sales").length > 0 && document.getElementById("dropbox-chooser-sales").appendChild(
        Dropbox.createChooseButton({
            success: function(e) {
                var t = {};
                t.rel_id = $("body").find('input[name="_attachment_sale_id"]').val(), t.type = $("body").find(
                    'input[name="_attachment_sale_type"]').val(), t.files = e, t.external = "dropbox", $.post(admin_url +
                    "misc/add_sales_external_attachment", t).done(function() {
                    "invoice" == t.type ? init_invoice(t.rel_id) : "credit_note" == t.type ? init_credit_note(t.rel_id) :
                        "estimate" == t.type ? $("body").hasClass("estimates-pipeline") ? estimate_pipeline_open(t.rel_id) :
                        init_estimate(t.rel_id) : "proposal" == t.type && ($("body").hasClass("proposals-pipeline") ?
                            proposal_pipeline_open(t.rel_id) : init_proposal(t.rel_id)), $("#sales_attach_file").modal("hide")
                })
            },
            linkType: "preview",
            extensions: app_allowed_files.split(",")
        ...
        sending: function(e, t, a) {
            a.append("rel_id", $("body").find('input[name="_attachment_sale_id"]').val()), a.append("type", $("body").find(
                'input[name="_attachment_sale_type"]').val())
        },
        success: function(e, t) {
            t = JSON.parse(t);
            var a, i, n = $("body").find('input[name="_attachment_sale_type"]').val();
            a = "download/file/sales_attachment/", i = "delete_" + n + "_attachment", "invoice" == n ? init_invoice(t.rel_id) :
                "credit_note" == n ? init_credit_note(t.rel_id) : "estimate" == n ? $("body").hasClass("estimates-pipeline") ?
                estimate_pipeline_open(t.rel_id) : init_estimate(t.rel_id) : "proposal" == n && ($("body").hasClass(
                    "proposals-pipeline") ? proposal_pipeline_open(t.rel_id) : init_proposal(t.rel_id));
            var s = "";
            1 == t.success && (s += '<div class="display-block sales-attach-file-preview" data-attachment-id="' + t.attachment_id +
                '">', s += '<div class="col-md-10">', s +=
                '<div class="pull-left"><i class="attachment-icon-preview fa fa-file-o"></i></div>', s += '<a href="' + site_url +
                a + t.key + '" target="_blank">' + t.file_name + "</a>", s += '<p class="text-muted">' + t.filetype + "</p>", s +=
                "</div>", s += '<div class="col-md-2 text-right">', s += '<a href="#" class="text-danger" onclick="' + i + "(" + t.attachment_id +
                '); return false;"><i class="fa fa-times"></i></a>', s += "</div>", s += '<div class="clearfix"></div><hr/>', s +=
                "</div>", $("#sales_uploaded_files_preview").append(s))
        }
        ...
        e.preventDefault(), $("#discount-total-type-dropdown").find(".discount-total-type").removeClass("selected"), $(this).addClass(
            "selected"), $(".discount-total-type-selected").html($(this).text()), $(this).hasClass("discount-type-percent") ? ($(
            ".input-discount-fixed").addClass("hide").val(0), $(".input-discount-percent").removeClass("hide")) : ($(
            ".input-discount-fixed").removeClass("hide"), $(".input-discount-percent").addClass("hide").val(0), $(
            "#discount_percent-error").remove()), calculate_total()
        ...
        if ("" == $('select[name="discount_type"]').val() && 0 != $(this).val()) return alert("You need to select discount type"), $(
            "html,body").animate({
            scrollTop: 0
        ...
        var e = $(this).val(),
            ...
            a = t.html("").clone(),
            i = $(".projects-wrapper");
        if (t.selectpicker("destroy").remove(), t = a, $("#project_ajax_search_wrapper").append(a), init_ajax_project_search_by_customer_id(),
            clear_billing_and_shipping_details(), !e) return $("#merge").empty(), $("#expenses_to_bill").empty(), $("#invoice_top_info").addClass(
            "hide"), i.addClass("hide"), !1;
        ...
        requestGetJSON("invoices/client_change_data/" + e + "/" + (n = void 0 === n ? "" : n)).done(function(e) {
            ...
            0 == t.length ? e.expenses_bill_info = "" : t.html(e.expenses_bill_info), "" != e.merge_info || "" != e.expenses_bill_info ?
                $("#invoice_top_info").removeClass("hide") : $("#invoice_top_info").addClass("hide");
            for (var a in bs_fields) bs_fields[a].indexOf("billing") > -1 && (bs_fields[a].indexOf("country") > -1 ? $('select[name="' +
                    bs_fields[a] + '"]').selectpicker("val", e.billing_shipping[0][bs_fields[a]]) : bs_fields[a].indexOf(
                    "billing_street") > -1 ? $('textarea[name="' + bs_fields[a] + '"]').val(e.billing_shipping[0][bs_fields[a]]) :
                $('input[name="' + bs_fields[a] + '"]').val(e.billing_shipping[0][bs_fields[a]]));
            empty(e.billing_shipping[0].shipping_street) || $('input[name="include_shipping"]').prop("checked", !0).change();
            for (var a in bs_fields) bs_fields[a].indexOf("shipping") > -1 && (bs_fields[a].indexOf("country") > -1 ? $('select[name="' +
                    bs_fields[a] + '"]').selectpicker("val", e.billing_shipping[0][bs_fields[a]]) : bs_fields[a].indexOf(
                    "shipping_street") > -1 ? $('textarea[name="' + bs_fields[a] + '"]').val(e.billing_shipping[0][bs_fields[a]]) :
                $('input[name="' + bs_fields[a] + '"]').val(e.billing_shipping[0][bs_fields[a]]));
            init_billing_and_shipping_details();
            ...
            if (o.length > 0) {
                ...
                }).remove(), $.each(e.billable_tasks, function(e, t) {
                    l = " ", 1 == t.started_timers ? l += 'disabled class="text-danger important" data-subtext="' + appLang.invoice_task_billable_timers_found +
                        '"' : l += 'data-subtext="' + t.rel_name + '"', o.append('<option value="' + t.id + '"' + l + ">" + t.name +
                            "</option>")
                }), o.selectpicker("refresh")
            }!0 === e.customer_has_projects ? i.removeClass("hide") : i.addClass("hide"), s.selectpicker("refresh"),
                init_currency_symbol()
        })
    }), 0 == $('input[name="isedit"]').length && $('.f_client_id select[name="clientid"]').change(), $("body").on("click",
        ...
        function(e) {
            ...
            "" != a && requestGetJSON("clients/get_customer_billing_and_shipping_details/" + a).done(function(e) {
                $('textarea[name="shipping_street"]').val(e[0].shipping_street), $('input[name="shipping_city"]').val(e[0].shipping_city),
                    $('input[name="shipping_state"]').val(e[0].shipping_state), $('input[name="shipping_zip"]').val(e[0].shipping_zip), $(
                        'select[name="shipping_country"]').selectpicker("val", e[0].shipping_country)
            })
        }), "undefined" != typeof accounting && (accounting.settings.currency.decimal = app_decimal_separator, accounting.settings.currency.thousand =
        app_thousand_separator, accounting.settings.currency.precision = app_decimal_places, accounting.settings.number.thousand =
        app_thousand_separator, accounting.settings.number.decimal = app_decimal_separator, accounting.settings.number.precision =
        app_decimal_places, calculate_total()), $("body").on("change", 'input[name="invoices_to_merge[]"]', function() {
        var e = $(this).prop("checked"),
            t = $(this).val();
        1 == e ? requestGetJSON("invoices/get_merge_data/" + t).done(function(e) {
            $.each(e.items, function(e, a) {
                "" != a.rel_type && ("task" == a.rel_type ? $('input[name="task_id"]').val(a.item_related_formatted_for_input) :
                        "expense" == a.rel_type && $('input[name="expense_id"]').val(a.item_related_formatted_for_input)),
                    _set_item_preview_custom_fields_array(a.custom_fields), add_item_to_table(a, "undefined", t)
            })
        ...
        current_desc_val = a.val(), current_desc_val = current_desc_val.trim(), "" != t && (1 == $(this).prop("checked") ? (e =
            current_desc_val + "\n" + t, a.val(e.trim())) : (a.val(current_desc_val.replace("\n" + t, "")), a.val(current_desc_val.replace(
            t, ""))))
    })
}), $(document).keyup(function(e) {
    27 == e.keyCode && ($(".modal").is(":visible") && 1 == $(".modal:visible").length && $("body").find(
        '.modal:visible [onclick^="close_modal_manually"]').eq(0).click(), $(".popup-wrapper").is(":visible") && $(".popup-wrapper").find(
